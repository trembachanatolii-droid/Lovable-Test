        ...
        <div className="container">
          <div className="header-content">
            ...
            <div className="desktop-search" style={{
              ...
              <button aria-label="Search site" type="button" style={{
                padding: '0.5rem',
                color: 'var(--gray-dark)',
            ...
            <div className="mobile-menu-btn">
              <button onClick={toggleMenu} aria-label="Open menu" type="button" style={{
                padding: '0.75rem',
                ...
                <MenuIcon style={{ height: '1.75rem', width: '1.75rem' }} aria-hidden="true" />
              </button>
            </div>
          </div>
        </div>
