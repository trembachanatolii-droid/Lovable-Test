...
const AlamedaTradeAttorneyPage: React.FC = () => {
  useMeta({
    title: 'Alameda Trade Attorney | Port Customs Lawyer CA',
    description: 'Alameda trade attorney serving Bay Area port importers. Export controls, customs compliance, maritime trade law. Oakland port access. (310) 744-1328.',
    canonical: 'alameda-trade-attorney',
    ogType: 'website',
    ogImage: `${siteConfig.siteUrl}/og-image-alameda.jpg`,
    schema: [
      generateWebPageSchema({
        title: 'Alameda Trade Attorney - California Port Customs Lawyer',
        description: 'Serving Alameda with expert trade compliance, export controls, and customs legal services for maritime businesses and port-adjacent companies.',
        url: `${siteConfig.siteUrl}/alameda-trade-attorney`,
      }),
      generateBreadcrumbSchema([
        { name: 'Home', url: `${siteConfig.siteUrl}/` },
        { name: 'Local Offices', url: `${siteConfig.siteUrl}/local-offices` },
        { name: 'Alameda', url: `${siteConfig.siteUrl}/alameda-trade-attorney` }
      ]),
      generateServiceSchema({
        name: 'Alameda Trade Compliance Legal Services',
        description: 'Comprehensive trade compliance, export controls, and customs legal representation for Alameda maritime businesses and port importers. Expert Alameda trade attorney services including EAR/ITAR compliance, customs valuation, Port of Oakland logistics support, maritime trade compliance, and CBP examination defense.',
  ...
  return (
    <div className="font-montserrat text-neutral-darkGray bg-white min-h-screen">
      ...
      <section className="hero" aria-label="Alameda Trade Law Hero">
        <picture className="hero-bg">
          <img
            src="https://images.unsplash.com/photo-1589802829985-817e51171b92?q=80&w=1920&auto=format&fit=crop"
            alt=""
            role="presentation"
            width="1920"
            height="1080"
        ...
        <div className="container">
          <h1>Alameda Trade Attorney<br />Port Customs Compliance</h1>
      ...
      {/* Why Alameda Businesses Need Us */}
      <section className="py-20 px-6 bg-white">
        <div className="max-w-[1200px] mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold font-garamond text-primary-navy mb-6">
              Trade Law for Alameda's Maritime Economy
            </h2>
            <div className="w-24 h-1 bg-secondary-teal mx-auto mb-6"></div>
            <p className="text-xl text-text-secondary max-w-3xl mx-auto leading-relaxed">
              Alameda's strategic location on San Francisco Bay provides direct access to the <strong>Port of Oakland</strong>, the nation's fifth-busiest container port. With proximity to maritime logistics operations and Bay Area distribution networks, Alameda businesses face complex <strong>customs regulations, import compliance requirements, and trade law challenges</strong>.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-neutral-50 p-8 rounded-lg border-l-4 border-secondary-teal">
              ...
              <p className="text-text-secondary leading-relaxed">
                As your Alameda trade attorney, we understand <strong>Port of Oakland logistics, Oakland International Container Terminal operations, and CBP examination procedures</strong>. We respond to customs holds, demurrage issues, and import violations within 24 hours.
              </p>
            </div>
            ...
            <div className="bg-neutral-50 p-8 rounded-lg border-l-4 border-secondary-teal">
              ...
              <p className="text-text-secondary leading-relaxed">
                We specialize in <strong>maritime customs compliance</strong>: containerized cargo, vessel documentation, ISF filings, and ocean freight regulations. We work with freight forwarders, customs brokers, and terminal operators serving Alameda businesses.
              </p>
            </div>
      ...
      {/* Services for Alameda Importers */}
      <section className="py-20 px-6 bg-neutral-50">
        <div className="max-w-[1200px] mx-auto">
          <h2 className="text-4xl md:text-5xl font-bold font-garamond text-primary-navy mb-12 text-center">
            Trade Compliance for Alameda Port Businesses
          </h2>
      ...
      {/* Why Alameda Companies Choose Us */}
      <section className="py-20 px-6 bg-white">
        <div className="max-w-[1200px] mx-auto">
          <h2 className="text-4xl md:text-5xl font-bold font-garamond text-primary-navy mb-12 text-center">
            Why Alameda Businesses Trust Our Trade Law Firm
          </h2>
          ...
          <div className="grid md:grid-cols-2 gap-8 justify-center">
            <div>
              ...
              <p className="text-text-secondary leading-relaxed mb-6">
                We understand <strong>Port of Oakland terminal operations, drayage routes, and CBP examination procedures</strong>. We've handled customs issues at SSA Marine, TraPac, Matson, and Everport terminals. We know the freight corridors along I-880 and I-580 connecting Alameda to distribution centers.
              </p>
            </div>
      ...
      <section className="py-20 px-6 bg-white">
        <div className="max-w-[1200px] mx-auto">
          <h2 className="text-4xl md:text-5xl font-bold font-garamond text-primary-navy mb-6 text-center">
            Deep Alameda Local Knowledge
          </h2>
          <p className="text-xl text-text-secondary text-center mb-12 max-w-3xl mx-auto">
            Our attorneys understand Alameda's maritime infrastructure, Port of Oakland logistics, and Bay Area trade corridors. We serve clients by appointment throughout Alameda County.
          </p>

          <div className="grid md:grid-cols-2 gap-8 mb-12 justify-center">
            {/* Port Access Routes */}
            <div className="bg-neutral-50 p-8 rounded-lg">
              <h3 className="text-2xl font-bold text-primary-navy mb-4 font-garamond">Alameda Port Access & Freight Routes</h3>
              ...
              <ul className="space-y-3 text-text-secondary">
                <li className="flex items-start">
                  ...
                  <span>Nimitz Freeway — primary Port of Oakland access from Alameda via Posey/Webster Tubes</span>
                </li>
                <li className="flex items-start">
                ...
                <li className="flex items-start">
                  ...
                  <span>Historical underwater tubes connecting Alameda to Oakland port district</span>
                </li>
                <li className="flex items-start">
            ...
            <div className="bg-neutral-50 p-8 rounded-lg">
              ...
              <p className="text-text-secondary mb-4">Key customs facilities serving Alameda importers:</p>
              <ul className="space-y-3 text-text-secondary">
                <li className="flex items-start">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-12 justify-center">
            ...
            <div className="bg-neutral-50 p-8 rounded-lg">
              <h3 className="text-2xl font-bold text-primary-navy mb-4 font-garamond">Alameda Maritime Business Districts</h3>
              <p className="text-text-secondary mb-4">Key commercial areas for trade-related businesses:</p>
              <ul className="space-y-3 text-text-secondary">
                <li className="flex items-start">
                  <span className="text-secondary-teal font-bold mr-2">Alameda Point</span>
            ...
            {/* Local Contact Info */}
            <div className="bg-neutral-50 p-8 rounded-lg">
              <h3 className="text-2xl font-bold text-primary-navy mb-4 font-garamond">Serving Alameda & Surrounding Areas</h3>
              <p className="text-text-secondary mb-4">Available by appointment throughout Alameda County:</p>
              <div className="grid grid-cols-2 gap-2 text-sm text-text-secondary mb-4">
                <span>Alameda</span>
                <span>Oakland</span>
                <span>Bay Farm Island</span>
                <span>Alameda Point</span>
...
export default AlamedaTradeAttorneyPage;
