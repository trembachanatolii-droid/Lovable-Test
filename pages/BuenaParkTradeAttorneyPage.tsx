...
const BuenaParkTradeAttorneyPage: React.FC = () => {
  useMeta({
    title: 'Buena Park Trade Attorney | Import Export Compliance Lawyer CA',
    description: 'Buena Park trade attorney for importers & distributors. Customs compliance, tariff classification, retail imports. Orange County. (310) 744-1328.',
    canonical: 'buena-park-trade-attorney',
    ogType: 'website',
    ogImage: `${siteConfig.siteUrl}/og-image-buena-park.jpg`,
    schema: [
      generateWebPageSchema({
        title: 'Buena Park Trade Compliance Attorney - Import Export Lawyer',
        description: 'Serving Buena Park, CA with expert trade compliance, import/export law, and customs legal services for manufacturers and distributors in Northwest Orange County.',
        url: `${siteConfig.siteUrl}/buena-park-trade-attorney`,
      }),
      generateBreadcrumbSchema([
        { name: 'Home', url: `${siteConfig.siteUrl}/` },
        { name: 'Local Offices', url: `${siteConfig.siteUrl}/local-offices` },
        { name: 'Buena Park', url: `${siteConfig.siteUrl}/buena-park-trade-attorney` }
      ]),
      generateServiceSchema({
        name: 'Buena Park Trade Compliance Legal Services',
        description: 'Comprehensive trade compliance, customs law, and import/export legal representation for Buena Park manufacturers and distributors.',
  ...
  return (
    <div className="font-montserrat text-neutral-darkGray bg-white min-h-screen">
      ...
      {/* Hero Section */}
      <section className="hero" aria-label="Buena Park Trade Law Hero">
        <picture className="hero-bg">
          <img
            src="https://images.unsplash.com/photo-1449247666642-264389f5f5b1?q=80&w=1920&auto=format&fit=crop"
            alt=""
            role="presentation"
            width="1920"
            height="1080"
        ...
        <div className="container">
          <h1>Buena Park Trade Attorney<br />Import Export Compliance Lawyer</h1>
          <p className="hero-subtitle">
            Strategic trade compliance counsel for Buena Park importers and distributors. Customs law, retail import compliance, and supply chain solutions in Northwest Orange County.
          </p>
        ...
        <div className="max-w-[1200px] mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold font-garamond text-primary-navy mb-6">
              Trade Law for Buena Park's Business Community
            </h2>
            <div className="w-24 h-1 bg-secondary-teal mx-auto mb-6"></div>
            <p className="text-xl text-text-secondary max-w-3xl mx-auto leading-relaxed">
              Buena Park businesses face complex <strong>import/export regulations</strong> that require specialized legal expertise. Whether you're importing components, exporting finished goods, or navigating <strong>customs compliance</strong>, our trade attorneys provide expert guidance.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-neutral-50 p-8 rounded-lg border-l-4 border-secondary-teal">
              ...
              <p className="text-text-secondary leading-relaxed">
                As your <strong>Buena Park trade attorney</strong>, we understand the local logistics corridors, port access routes, and regional supply chains in Northwest Orange County. Strategic, practical counsel.
              </p>
            </div>
            ...
            <div className="bg-neutral-50 p-8 rounded-lg border-l-4 border-secondary-teal">
              ...
              <p className="text-text-secondary leading-relaxed">
                We serve Buena Park's key industries with tariff classification, USMCA compliance, and Section 301 mitigation strategies tailored to your business needs.
              </p>
            </div>
      ...
      <section className="py-20 px-6 bg-neutral-50">
        <div className="max-w-[1200px] mx-auto">
          <h2 className="text-4xl md:text-5xl font-bold font-garamond text-primary-navy mb-12 text-center">
            Trade Compliance Services for Buena Park Companies
          </h2>
      ...
      <section className="py-20 px-6 bg-white">
        <div className="max-w-[1200px] mx-auto">
          <h2 className="text-4xl md:text-5xl font-bold font-garamond text-primary-navy mb-12 text-center">
            Why Buena Park Businesses Trust Us
          </h2>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              ...
              <p className="text-text-secondary leading-relaxed mb-6">
                We understand Buena Park's logistics corridors and regional supply chains. Local knowledge means faster issue resolution.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-text-secondary leading-relaxed mb-6">
                We serve Buena Park's key industries. We understand your products, margins, and regulatory pressures.
              </p>
            </div>
      ...
      <section className="py-20 px-6 bg-neutral-50">
        <div className="max-w-[1200px] mx-auto">
          <h2 className="text-4xl md:text-5xl font-bold font-garamond text-primary-navy mb-12 text-center">
            Buena Park Industries We Serve
          </h2>
      ...
      <section className="py-20 px-6 bg-white">
        <div className="max-w-[1200px] mx-auto">
          <h2 className="text-4xl md:text-5xl font-bold font-garamond text-primary-navy mb-6 text-center">
            Deep Buena Park Local Knowledge
          </h2>
          <p className="text-xl text-text-secondary text-center mb-12 max-w-3xl mx-auto">
            Our attorneys understand Buena Park's position in Northwest Orange County, with excellent access to LA/Long Beach ports. We serve clients by appointment throughout the Buena Park area.
          </p>
      ...
      <section className="py-20 px-6 bg-primary-navy text-white">
        <div className="max-w-[900px] mx-auto text-center">
          ...
          <p className="text-xl mb-8 opacity-95 leading-relaxed text-white">
            Don't let customs compliance issues slow your business. Contact our Buena Park trade attorney team for expert counsel.
          </p>
...
export default BuenaParkTradeAttorneyPage;
