...
const ChulaVistaCustomsBrokerPage: React.FC = () => {
  useMeta({
    title: 'Customs Broker Liability Attorney Chula Vista | Broker Defense Lawyer',
    description: 'Chula Vista customs broker liability attorney. Expert broker negligence defense, CBP broker violations, broker license defense, professional liability. (310) 744-1328.',
    keywords: 'customs broker liability attorney chula vista, customs broker defense lawyer chula vista, broker negligence attorney, cbp broker violations lawyer, customs broker license defense california',
    canonical: 'chula-vista-customs-broker-liability-attorney',
    ogType: 'website',
    ogImage: `${siteConfig.siteUrl}/og-image-broker-chula-vista.jpg`,
    schema: [
  ...
  return (
    <div className="font-montserrat text-neutral-darkGray bg-white min-h-screen">
      ...
      {/* Hero Section */}
      <section className="hero" aria-label="Chula Vista Customs Broker Liability Attorney Hero">
        ...
        <div className="container">
          <h1>Chula Vista Customs Broker Liability Attorney<br />Broker Defense Lawyer</h1>
          <p className="hero-subtitle">
            Expert customs broker liability attorney serving Chula Vista and South Bay brokers. Specialized broker negligence defense, CBP license violations, professional liability, and broker disciplinary proceedings.
          </p>
      ...
      <section className="py-20 px-6 bg-white">
        <div className="max-w-[1200px] mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-neutral-50 p-8 rounded-lg border-l-4 border-secondary-teal">
              <h3 className="text-2xl font-bold text-primary-navy mb-4 font-garamond">South Bay Knowledge</h3>
              <p className="text-text-secondary leading-relaxed">
                Understanding of <strong>Chula Vista CBP port operations</strong> and local broker community challenges near Otay Mesa and San Diego ports.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 px-6 bg-neutral-50">
        <div className="max-w-[1200px] mx-auto">
          <h2 className="text-4xl md:text-5xl font-bold font-garamond text-primary-navy mb-12 text-center">
            Serving Chula Vista & South Bay Customs Brokers
          </h2>

          <div className="grid md:grid-cols-2 gap-8 mb-12">
            <div className="bg-white p-8 rounded-lg">
              <h3 className="text-2xl font-bold text-primary-navy mb-4 font-garamond">Otay Mesa Border Brokers</h3>
              <p className="text-text-secondary leading-relaxed mb-4">
                We serve <strong>customs brokers</strong> operating in Chula Vista and South Bay:
              </p>
              <ul className="space-y-2 text-text-secondary">
                <li>• Otay Mesa port-area brokerage firms</li>
                <li>• Chula Vista customs brokers</li>
                <li>• South Bay border brokers</li>
            ...
            <div className="bg-white p-8 rounded-lg">
              ...
              <ul className="space-y-2 text-text-secondary">
                ...
                <li>• Air cargo brokers (SAN, LAX)</li>
      ...
      <section className="py-16 px-6 bg-neutral-50">
        <div className="max-w-[1200px] mx-auto">
          <h2 className="text-3xl font-bold font-garamond text-primary-navy mb-8 text-center">
            Chula Vista Customs Broker Defense
          </h2>
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div className="text-center md:text-left">
              ...
              <address className="not-italic text-text-secondary leading-relaxed mb-4">
                ...
                (Serving Chula Vista & South Bay Customs Brokers)<br /><br />
        ...
        <div className="max-w-[1200px] mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md overflow-hidden">
              ...
              <div className="space-y-0">
                <div className="service-link-item">
                  <Link to="/san-diego-port-operations-attorney" className="service-link">
                    <span className="service-link__title">San Diego Port Operations</span>
                    <div className="triangle-slide">
                      <svg className="triangle-slide__icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                        <path d="M5 12h14M12 5l7 7-7 7"/>
                      </svg>
      ...
      <RelatedCityPages currentCity="Chula Vista" region="california" />
      ...
      <section className="py-20 px-6 bg-primary-navy text-white">
        <div className="max-w-[900px] mx-auto text-center">
          ...
          <p className="text-xl mb-8 opacity-95 leading-relaxed text-white">
            Contact our Chula Vista customs broker liability attorneys today. We'll assess your situation, explain your options, and develop an aggressive defense strategy to protect your broker license.
          </p>
...
export default ChulaVistaCustomsBrokerPage;
