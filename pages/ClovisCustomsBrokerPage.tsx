...
const ClovisCustomsBrokerPage: React.FC = () => {
  useMeta({
    title: 'Customs Broker Liability Attorney Clovis | Broker Defense Lawyer',
    description: 'Clovis customs broker liability attorney. Expert broker negligence defense, CBP broker violations, broker license defense, professional liability. (310) 744-1328.',
    keywords: 'customs broker liability attorney clovis, customs broker defense lawyer clovis, broker negligence attorney, cbp broker violations lawyer, customs broker license defense california',
    canonical: 'clovis-customs-broker-liability-attorney',
    ogType: 'website',
    ogImage: `${siteConfig.siteUrl}/og-image-broker-clovis.jpg`,
    schema: [
      generateLocalBusinessSchema(),
      generateWebPageSchema({
        title: 'Clovis Customs Broker Liability Attorney - Broker Defense & Professional Liability Lawyer',
        description: 'Clovis customs broker liability attorney specializing in broker negligence defense, CBP broker violations, license defense, and professional liability.',
        url: `${siteConfig.siteUrl}/clovis-customs-broker-liability-attorney`,
      }),
      generateBreadcrumbSchema([
        { name: 'Home', url: `${siteConfig.siteUrl}/` },
        { name: 'California Service Areas', url: `${siteConfig.siteUrl}/california-offices` },
        { name: 'Clovis Customs Broker Liability Attorney', url: `${siteConfig.siteUrl}/clovis-customs-broker-liability-attorney` }
      ]),
      generateFAQSchema([
        {
    ...
    <div className="font-montserrat text-neutral-darkGray bg-white min-h-screen">
      ...
      <section className="hero" aria-label="Clovis Customs Broker Liability Attorney Hero">
        ...
        <div className="container">
          <h1>Clovis Customs Broker Liability Attorney<br />Broker Defense Lawyer</h1>
        ...
        <div className="max-w-[1200px] mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-neutral-50 p-8 rounded-lg border-l-4 border-secondary-teal">
              ...
              <p className="text-text-secondary leading-relaxed">
                Understanding of <strong>Clovis CBP operations</strong> and local broker community challenges serving Central Valley agricultural trade.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 px-6 bg-neutral-50">
        <div className="max-w-[1200px] mx-auto">
          <h2 className="text-4xl md:text-5xl font-bold font-garamond text-primary-navy mb-12 text-center">
            Serving Clovis & Central Valley Customs Brokers
          </h2>

          <div className="grid md:grid-cols-2 gap-8 mb-12">
            <div className="bg-white p-8 rounded-lg">
              <h3 className="text-2xl font-bold text-primary-navy mb-4 font-garamond">Central Valley Brokers</h3>
              <p className="text-text-secondary leading-relaxed mb-4">
                We serve <strong>customs brokers</strong> operating in Clovis and Central Valley:
              </p>
              <ul className="space-y-2 text-text-secondary">
                <li>• Clovis customs brokers</li>
                <li>• Fresno-area brokerage firms</li>
                <li>• Central Valley agricultural trade brokers</li>
            ...
            <div className="bg-white p-8 rounded-lg">
              ...
              <ul className="space-y-2 text-text-secondary">
                ...
                <li>• Air cargo brokers (FAT, SFO, LAX)</li>
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div className="text-center md:text-left">
              ...
              <address className="not-italic text-text-secondary leading-relaxed mb-4">
                ...
                (Serving Clovis & Central Valley Customs Brokers)<br /><br />
      ...
      <section className="py-20 px-6 bg-white">
        <div className="max-w-[1200px] mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md overflow-hidden">
              <h3 className="text-xl font-bold text-primary-navy mb-4 font-garamond">Agricultural Trade</h3>
              <div className="space-y-0">
                <div className="service-link-item">
                  <a href="#fresno-agricultural-trade" className="service-link">
      ...
      <RelatedCityPages currentCity="Clovis" region="california" />
...
export default ClovisCustomsBrokerPage;
