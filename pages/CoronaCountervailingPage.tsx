...
const CoronaCountervailingPage: React.FC = () => {
  useMeta({
    ...
    description:
      'Corona countervailing duty attorney defending against foreign subsidy duties. Expert CVD scope rulings, Commerce defense, Inland Empire trade law. (310) 744-1328.',
    keywords:
      'countervailing duty attorney corona, cvd lawyer corona, subsidy defense attorney, commerce department lawyer corona, inland empire customs lawyer, trade remedy attorney',
    ...
    schema: [
      ...
      generateBreadcrumbSchema([
        { name: 'Home', url: `${siteConfig.siteUrl}/` },
        {
          ...
          url: `${siteConfig.siteUrl}/#california-offices`,
        },
        {
      ...
      generateFAQSchema([
        ...
        },
        {
          ...
          // IMPORTANT: double quotes because the text contains CBP's
          answer:
            "Yes. CBP's Enforce and Protect Act (EAPA) investigates CVD evasion through transshipment or country of origin misrepresentation. EAPA investigations can result in detention of goods and massive retroactive CVD. Our Corona attorney provides immediate EAPA response including comprehensive documentation, supply chain verification, and substantial transformation analysis.",
        },
        {
          question: 'Do you serve other Inland Empire cities besides Corona?',
          answer:
            'Yes, from our Corona location we serve the entire Inland Empire including Riverside, Ontario, Rancho Cucamonga, Fontana, Moreno Valley, and the entire warehouse district. We represent manufacturers, distributors, importers, and logistics companies throughout the Inland Empire with countervailing duty and customs legal services.',
        },
      ]),
    ],
  });
    ...
    <div className="font-montserrat text-neutral-darkGray bg-white min-h-screen">
      ...
      <section className="hero" aria-label="Corona Countervailing Duty Attorney Hero">
        ...
        <div className="container">
          <h1>
            Corona Countervailing Duty Attorney
            <br />
            CVD Defense & Subsidy Law
          </h1>
          <p className="hero-subtitle">
            Expert countervailing duty defense for Corona and Inland Empire. CVD scope rulings,
        ...
        <div className="max-w-[1200px] mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-text-secondary max-w-3xl mx-auto leading-relaxed">
              Countervailing duties can add <strong>10% to 200%+ in additional tariffs</strong> to
              offset foreign government subsidies. These duties affect Corona warehouse operators,
              manufacturers, and distributors handling steel, aluminum, furniture, building
              materials, and consumer goods. Our Corona countervailing duty attorney helps you
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-neutral-50 p-8 rounded-lg border-l-4 border-secondary-teal">
              ...
              <p className="text-text-secondary leading-relaxed">
                Focused expertise on <strong>countervailing duty law and subsidy analysis</strong>.
                Commerce Department scope rulings, administrative reviews, and CVD defense.
              </p>
            </div>
            ...
            <div className="bg-neutral-50 p-8 rounded-lg border-l-4 border-secondary-teal">
              ...
              <p className="text-text-secondary leading-relaxed">
                Deep understanding of <strong>Corona warehouse and distribution</strong> CVD
                compliance challenges for imported goods.
              </p>
            </div>

            <div className="bg-neutral-50 p-8 rounded-lg border-l-4 border-secondary-teal">
              <h3 className="text-2xl font-bold text-primary-navy mb-4 font-garamond">
                Commerce Department Experience
              </h3>
              <p className="text-text-secondary leading-relaxed">
                Extensive experience with <strong>Commerce Department CVD proceedings</strong>, scope
                rulings, and subsidy verification.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="space-y-6">
            <div className="bg-white p-8 rounded-lg shadow-md hover:shadow-lg transition-shadow">
              <h3 className="text-2xl font-bold text-primary-navy mb-3 font-garamond">
                CVD Scope Ruling Requests
              </h3>
              <p className="text-text-secondary leading-relaxed mb-4">
                A successful CVD scope ruling excludes your product from countervailing duty
                orders, <strong>eliminating massive subsidy duty liability</strong>. Our Corona
                attorney prepares:
              </p>
            ...
            <div className="bg-white p-8 rounded-lg shadow-md hover:shadow-lg transition-shadow">
              <h3 className="text-2xl font-bold text-primary-navy mb-3 font-garamond">
                CVD Risk Assessment for Warehouses
              </h3>
              <p className="text-text-secondary leading-relaxed mb-4">
            ...
            <div className="bg-white p-8 rounded-lg shadow-md hover:shadow-lg transition-shadow">
              <h3 className="text-2xl font-bold text-primary-navy mb-3 font-garamond">
                EAPA CVD Evasion Defense
              </h3>
              <p className="text-text-secondary leading-relaxed mb-4">
                CBP&apos;s Enforce and Protect Act (EAPA) investigates{' '}
                <strong>CVD evasion through transshipment or misrepresentation</strong>:
              </p>
              <ul className="list-disc list-inside space-y-2 text-text-secondary">
            ...
            <div className="bg-white p-8 rounded-lg shadow-md hover:shadow-lg transition-shadow">
              <h3 className="text-2xl font-bold text-primary-navy mb-3 font-garamond">
                Country of Origin Planning to Avoid CVD
              </h3>
              <p className="text-text-secondary leading-relaxed mb-4">
        ...
        <div className="max-w-[1200px] mx-auto">
            ...
            {[
              {
                ...
                examples:
                  'Steel pipe, rebar, wire, aluminum extrusions, metal fabrication facing CVD from China, India, Mexico, Vietnam',
              },
              {
                title: 'Furniture & Cabinets',
                impact: 'U.S. CVD 0-216%',
                examples:
                  'Wooden furniture, bedroom sets, cabinets, office furniture from China, Vietnam subject to massive CVD',
              },
              {
                title: 'Building Materials',
                impact: 'U.S. CVD 20-180%',
                examples:
                  'Hardwood plywood, flooring, lumber products, construction materials facing CVD for foreign subsidies',
              },
              {
                title: 'Warehouse & Distribution Goods',
                impact: 'U.S. CVD 5-150%',
                examples:
                  'Tires, paper products, chemicals, consumer goods stored in Corona warehouses may be CVD-covered',
              },
            ].map((industry) => (
              <div
                key={industry.title}
                className="bg-neutral-50 p-6 rounded-lg border-l-4 border-secondary-teal"
              >
                <h3 className="text-xl font-bold text-primary-navy mb-2 font-garamond">
                  {industry.title}
                </h3>
                <div className="mb-2">
          ...
          <div className="bg-primary-navy text-white p-8 rounded-lg text-center">
            ...
            <p className="text-neutral-200">
              The U.S. maintains over 400 active countervailing duty orders covering thousands of
              products. Corona warehouse and distribution companies face significant CVD exposure.
          ...
          <div className="grid md:grid-cols-2 gap-8 justify-center">
            <div>
              ...
              <p className="text-text-secondary leading-relaxed mb-6">
                We specialize in <strong>countervailing duty law and subsidy analysis</strong> - not
                general customs. Deep expertise in Commerce Department procedures, scope
                interpretations, and CVD defense strategies.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-text-secondary leading-relaxed mb-6">
                Understanding of <strong>Corona warehouse district</strong> operations and CVD
                compliance challenges for distribution centers.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-text-secondary leading-relaxed mb-6">
                <strong>Successful CVD scope exclusions</strong> saving Corona importers millions
                through well-crafted ruling requests and technical analysis.
              </p>
            </div>
      ...
      <section className="py-20 px-6 bg-primary-navy text-white" id="schedule-consultation">
        <div className="max-w-[900px] mx-auto text-center">
          ...
          <p className="text-xl mb-8 opacity-95 leading-relaxed text-white">
            ...
            attorney helps you avoid or minimize these duties through scope rulings, subsidy analysis,
            and Commerce Department defense. Free consultation.
          </p>
