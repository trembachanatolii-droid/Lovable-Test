...
const CostaMesaCustomsBrokerPage: React.FC = () => {
  useMeta({
    title: 'Customs Broker Liability Attorney Costa Mesa | Broker Defense Lawyer',
    description: 'Costa Mesa customs broker liability attorney. Expert broker negligence defense, CBP broker violations, broker license defense, professional liability. (310) 744-1328.',
    keywords: 'customs broker liability attorney costa mesa, customs broker defense lawyer costa mesa, broker negligence attorney, cbp broker violations lawyer, customs broker license defense california',
    canonical: 'costa-mesa-customs-broker-liability-attorney',
    ogType: 'website',
    ogImage: `${siteConfig.siteUrl}/og-image-broker-costa-mesa.jpg`,
    schema: [
  ...
  return (
    <div className="font-montserrat text-neutral-darkGray bg-white min-h-screen">
      ...
      {/* Hero Section */}
      <section className="hero" aria-label="Costa Mesa Customs Broker Liability Attorney Hero">
        ...
        <div className="container">
          <h1>Costa Mesa Customs Broker Liability Attorney<br />Broker Defense Lawyer</h1>
          <p className="hero-subtitle">
            Expert customs broker liability attorney serving Costa Mesa and Orange County brokers. Specialized broker negligence defense, CBP license violations, professional liability, and broker disciplinary proceedings.
          </p>
        ...
        <div className="max-w-[1200px] mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-neutral-50 p-8 rounded-lg border-l-4 border-secondary-teal">
              ...
              <p className="text-text-secondary leading-relaxed">
                Understanding of <strong>Costa Mesa CBP operations</strong> and local broker community challenges in Orange County trade corridor.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 px-6 bg-neutral-50">
        <div className="max-w-[1200px] mx-auto">
          <h2 className="text-4xl md:text-5xl font-bold font-garamond text-primary-navy mb-12 text-center">
            Serving Costa Mesa & Orange County Customs Brokers
          </h2>

          <div className="grid md:grid-cols-2 gap-8 mb-12">
            <div className="bg-white p-8 rounded-lg">
              <h3 className="text-2xl font-bold text-primary-navy mb-4 font-garamond">Orange County Brokers</h3>
              <p className="text-text-secondary leading-relaxed mb-4">
                We serve <strong>customs brokers</strong> operating in Costa Mesa and Orange County:
              </p>
              <ul className="space-y-2 text-text-secondary">
                <li>• Costa Mesa customs brokers</li>
                <li>• Orange County brokerage firms</li>
                <li>• Irvine trade community brokers</li>
            ...
            <div className="bg-white p-8 rounded-lg">
              ...
              <ul className="space-y-2 text-text-secondary">
                ...
                <li>• Air cargo brokers (SNA, LAX)</li>
      ...
      <section className="py-16 px-6 bg-neutral-50">
        <div className="max-w-[1200px] mx-auto">
          <h2 className="text-3xl font-bold font-garamond text-primary-navy mb-8 text-center">
            Costa Mesa Customs Broker Defense
          </h2>
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div className="text-center md:text-left">
              ...
              <address className="not-italic text-text-secondary leading-relaxed mb-4">
                ...
                (Serving Costa Mesa & Orange County Customs Brokers)<br /><br />
      ...
      <RelatedCityPages currentCity="Costa Mesa" region="california" />
      ...
      <section className="py-20 px-6 bg-primary-navy text-white">
        <div className="max-w-[900px] mx-auto text-center">
          ...
          <p className="text-xl mb-8 opacity-95 leading-relaxed text-white">
            Contact our Costa Mesa customs broker liability attorneys today. We'll assess your situation, explain your options, and develop an aggressive defense strategy to protect your broker license.
          </p>
...
export default CostaMesaCustomsBrokerPage;
