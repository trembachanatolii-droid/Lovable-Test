...
const CovinaTradeAttorneyPage: React.FC = () => {
  useMeta({
    title: 'Covina Trade Attorney | Los Angeles County Manufacturing & Distribution Trade Law CA',
    description: 'Covina trade attorney. Covina trade attorney for manufacturing exports, distribution compliance, and customs regulations. (310) 744-1328.',
    canonical: 'covina-trade-attorney',
    ogType: 'website',
    ogImage: `${siteConfig.siteUrl}/og-image-covina-trade-attorney.jpg`,
    schema: [
      generateWebPageSchema({
        title: 'Covina Trade Attorney - Los Angeles County Manufacturing & Distribution Trade Law',
        description: 'Covina trade attorney for manufacturing exports, distribution compliance, and customs regulations',
        url: `${siteConfig.siteUrl}/covina-trade-attorney`,
      }),
      generateBreadcrumbSchema([
        { name: 'Home', url: `${siteConfig.siteUrl}/` },
        { name: 'Local Offices', url: `${siteConfig.siteUrl}/local-offices` },
        { name: 'Covina', url: `${siteConfig.siteUrl}/covina-trade-attorney` }
      ]),
      generateServiceSchema({
        name: 'Covina Trade Compliance Legal Services',
        description: 'Covina trade attorney for manufacturing exports, distribution compliance, and customs regulations',
    ...
    <div className="font-montserrat text-neutral-darkGray bg-white min-h-screen">
      ...
      <section className="hero" aria-label="Covina Trade Law Hero">
        ...
        <div className="container">
          <h1>Covina Trade Attorney<br />Export Compliance & Customs Law</h1>
          <p className="hero-subtitle">
            Expert trade compliance, export controls, and customs legal services for Covina businesses. Los Angeles County Manufacturing & Distribution Trade Law representation.
          </p>
        ...
        <div className="max-w-[1200px] mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold font-garamond text-primary-navy mb-6">
              Trade Law for Covina Businesses
            </h2>
            <div className="w-24 h-1 bg-secondary-teal mx-auto mb-6"></div>
            <p className="text-xl text-text-secondary max-w-3xl mx-auto leading-relaxed">
              Covina businesses engaged in international trade face complex regulatory requirements. From <strong>export controls and customs compliance to OFAC sanctions screening</strong>, navigating trade regulations requires specialized legal expertise.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-neutral-50 p-8 rounded-lg border-l-4 border-secondary-teal">
              ...
              <p className="text-text-secondary leading-relaxed">
                Navigate <strong>EAR/ITAR export regulations, ECCN classifications, and export license applications</strong> for Covina companies shipping products internationally.
              </p>
            </div>
            ...
            <div className="bg-neutral-50 p-8 rounded-lg border-l-4 border-secondary-teal">
              ...
              <p className="text-text-secondary leading-relaxed">
                Implement <strong>OFAC sanctions compliance programs, restricted party screening, and trade embargo compliance</strong> for Covina exporters.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 px-6 bg-neutral-50">
        <div className="max-w-[1200px] mx-auto">
          <h2 className="text-4xl md:text-5xl font-bold font-garamond text-primary-navy mb-12 text-center">
            Trade Compliance Services for Covina
          </h2>
          ...
          <div className="space-y-6">
            <div className="bg-white p-8 rounded-lg shadow-md hover:shadow-lg transition-shadow">
              ...
              <p className="text-text-secondary leading-relaxed mb-4">
                Covina companies exporting technology, software, or controlled products must comply with <strong>Export Administration Regulations (EAR) and International Traffic in Arms Regulations (ITAR)</strong>. We provide ECCN classifications, license applications, and export compliance program design.
              </p>
            ...
            <div className="bg-white p-8 rounded-lg shadow-md hover:shadow-lg transition-shadow">
              ...
              <p className="text-text-secondary leading-relaxed mb-4">
                Proper customs compliance protects Covina businesses from penalties, seizures, and supply chain disruptions. We handle <strong>HTS classification, customs valuation, duty mitigation, and CBP audits</strong>.
              </p>
              <ul className="list-disc list-inside space-y-2 text-text-secondary">
            ...
            <div className="bg-white p-8 rounded-lg shadow-md hover:shadow-lg transition-shadow">
              ...
              <p className="text-text-secondary leading-relaxed mb-4">
                Selling to sanctioned countries or parties can result in severe penalties. We help Covina businesses implement <strong>OFAC compliance programs, screen customers against restricted party lists, and handle blocked transactions</strong>.
              </p>
              <ul className="list-disc list-inside space-y-2 text-text-secondary">
            ...
            <div className="bg-white p-8 rounded-lg shadow-md hover:shadow-lg transition-shadow">
              ...
              <p className="text-text-secondary leading-relaxed mb-4">
                Effective trade compliance programs prevent violations and demonstrate good faith to regulators. We design <strong>scalable compliance programs</strong> tailored to Covina business operations.
              </p>
              <ul className="list-disc list-inside space-y-2 text-text-secondary">
            ...
            <div className="bg-white p-8 rounded-lg shadow-md hover:shadow-lg transition-shadow">
              ...
              <p className="text-text-secondary leading-relaxed mb-4">
                If your Covina business receives a subpoena, charging letter, or penalty notice from BIS, OFAC, or CBP, immediate legal representation is critical. We defend clients in <strong>administrative enforcement proceedings and voluntary self-disclosures</strong>.
              </p>
              <ul className="list-disc list-inside space-y-2 text-text-secondary">
            ...
            <div className="bg-white p-8 rounded-lg shadow-md hover:shadow-lg transition-shadow">
              ...
              <p className="text-text-secondary leading-relaxed mb-4">
                Covina importers and manufacturers can leverage <strong>Foreign Trade Zones (FTZ), duty drawback programs, and first sale for export valuation</strong> to reduce customs duties and improve cash flow.
              </p>
              <ul className="list-disc list-inside space-y-2 text-text-secondary">
      ...
      <section className="py-20 px-6 bg-white">
        <div className="max-w-[1200px] mx-auto">
          <h2 className="text-4xl md:text-5xl font-bold font-garamond text-primary-navy mb-12 text-center">
            Why Covina Businesses Trust Us
          </h2>
      ...
      <section className="py-20 px-6 bg-white">
        <div className="max-w-[1200px] mx-auto">
          <h2 className="text-4xl md:text-5xl font-bold font-garamond text-primary-navy mb-6 text-center">
            Deep Covina Local Knowledge
          </h2>
          <p className="text-xl text-text-secondary text-center mb-12 max-w-3xl mx-auto">
            Our attorneys understand Covina's business environment, transportation infrastructure, and trade corridors. We serve clients by appointment throughout the region.
          </p>

          <div className="bg-neutral-50 p-8 rounded-lg mb-8">
            <h3 className="text-2xl font-bold text-primary-navy mb-4 font-garamond">Covina Business & Trade Environment</h3>
            <p className="text-text-secondary mb-4">
              Covina businesses benefit from California's extensive trade infrastructure and proximity to major ports. We provide local expertise combined with deep knowledge of federal trade regulations.
            </p>
      ...
      <section className="py-20 px-6 bg-primary-navy text-white">
        <div className="max-w-[900px] mx-auto text-center">
          ...
          <p className="text-xl mb-8 opacity-95 leading-relaxed text-white">
            Don't let complex trade regulations slow down your business. Contact our Covina trade attorney team for expert export controls, customs compliance, and sanctions guidance.
          </p>
...
export default CovinaTradeAttorneyPage;
