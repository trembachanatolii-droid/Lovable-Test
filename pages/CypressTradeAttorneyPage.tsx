...
const CypressTradeAttorneyPage: React.FC = () => {
  useMeta({
    title: 'Cypress Trade Attorney | Import Export Customs Lawyer CA',
    description: 'Cypress trade attorney for manufacturers & distributors. Customs compliance, USMCA, tariff classification. Orange County. (310) 744-1328.',
    canonical: 'cypress-trade-attorney',
    ogType: 'website',
    ogImage: `${siteConfig.siteUrl}/og-image-cypress.jpg`,
    schema: [
      generateWebPageSchema({
        title: 'Cypress Trade Compliance Attorney - Import Export Lawyer',
        description: 'Serving Cypress, CA with expert trade compliance, import/export law, and customs legal services for manufacturers and distributors in Northwest Orange County.',
        url: `${siteConfig.siteUrl}/cypress-trade-attorney`,
      }),
      generateBreadcrumbSchema([
        { name: 'Home', url: `${siteConfig.siteUrl}/` },
        { name: 'Local Offices', url: `${siteConfig.siteUrl}/local-offices` },
        { name: 'Cypress', url: `${siteConfig.siteUrl}/cypress-trade-attorney` }
      ]),
      generateServiceSchema({
        name: 'Cypress Trade Compliance Legal Services',
        description: 'Comprehensive trade compliance, customs law, and import/export legal representation for Cypress manufacturers and distributors.',
    ...
    <div className="font-montserrat text-neutral-darkGray bg-white min-h-screen">
      ...
      <section className="hero" aria-label="Cypress Trade Law Hero">
        ...
        <div className="container">
          <h1>Cypress Trade Attorney<br />Import Export Compliance Lawyer</h1>
          <p className="hero-subtitle">
            Expert trade compliance counsel for Cypress businesses. Customs law, import/export compliance, and supply chain solutions in Northwest Orange County.
          </p>
        ...
        <div className="max-w-[1200px] mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold font-garamond text-primary-navy mb-6">
              Trade Law for Cypress's Business Community
            </h2>
            <div className="w-24 h-1 bg-secondary-teal mx-auto mb-6"></div>
            <p className="text-xl text-text-secondary max-w-3xl mx-auto leading-relaxed">
              Cypress businesses face complex <strong>import/export regulations</strong> that require specialized legal expertise. Whether you're importing components, exporting finished goods, or navigating <strong>customs compliance</strong>, our trade attorneys provide expert guidance.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-neutral-50 p-8 rounded-lg border-l-4 border-secondary-teal">
              ...
              <p className="text-text-secondary leading-relaxed">
                As your <strong>Cypress trade attorney</strong>, we understand the local logistics corridors, port access routes, and regional supply chains in Northwest Orange County. Strategic, practical counsel.
              </p>
            </div>
            ...
            <div className="bg-neutral-50 p-8 rounded-lg border-l-4 border-secondary-teal">
              ...
              <p className="text-text-secondary leading-relaxed">
                We serve Cypress's key industries with tariff classification, USMCA compliance, and Section 301 mitigation strategies tailored to your business needs.
              </p>
            </div>
      ...
      <section className="py-20 px-6 bg-neutral-50">
        <div className="max-w-[1200px] mx-auto">
          <h2 className="text-4xl md:text-5xl font-bold font-garamond text-primary-navy mb-12 text-center">
            Trade Compliance Services for Cypress Companies
          </h2>
      ...
      <section className="py-20 px-6 bg-white">
        <div className="max-w-[1200px] mx-auto">
          <h2 className="text-4xl md:text-5xl font-bold font-garamond text-primary-navy mb-12 text-center">
            Why Cypress Businesses Trust Us
          </h2>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              ...
              <p className="text-text-secondary leading-relaxed mb-6">
                We understand Cypress's logistics corridors and regional supply chains. Local knowledge means faster issue resolution.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-text-secondary leading-relaxed mb-6">
                We serve Cypress's key industries. We understand your products, margins, and regulatory pressures.
              </p>
            </div>
      ...
      <section className="py-20 px-6 bg-white">
        <div className="max-w-[1200px] mx-auto">
          <h2 className="text-4xl md:text-5xl font-bold font-garamond text-primary-navy mb-6 text-center">
            Deep Cypress Local Knowledge
          </h2>
          <p className="text-xl text-text-secondary text-center mb-12 max-w-3xl mx-auto">
            Our attorneys understand Cypress's position in Northwest Orange County, with excellent access to LA/Long Beach ports. We serve clients by appointment throughout the Cypress area.
          </p>
      ...
      <section className="py-20 px-6 bg-primary-navy text-white">
        <div className="max-w-[900px] mx-auto text-center">
          ...
          <p className="text-xl mb-8 opacity-95 leading-relaxed text-white">
            Don't let customs compliance issues slow your business. Contact our Cypress trade attorney team for expert counsel.
          </p>
...
export default CypressTradeAttorneyPage;
