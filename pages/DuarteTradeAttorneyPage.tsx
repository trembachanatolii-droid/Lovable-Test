...
const DuarteTradeAttorneyPage: React.FC = () => {
  useMeta({
    title: 'Duarte Trade Attorney | San Gabriel Valley CA Customs Lawyer',
    description: 'Duarte trade compliance attorney. Healthcare and biotech corridor, City of Hope. Import/export, tariff classification, CBP defense. (310) 744-1328.',
    canonical: 'duarte-trade-attorney',
    ogType: 'website',
    ogImage: `${siteConfig.siteUrl}/og-image-duarte.jpg`,
    schema: [
      generateWebPageSchema({
        title: 'Duarte Trade Attorney - San Gabriel Valley Customs Compliance',
        description: 'Serving Duarte with expert trade compliance, customs defense, and import/export legal services.',
        url: `${siteConfig.siteUrl}/duarte-trade-attorney`,
      }),
      generateBreadcrumbSchema([
        { name: 'Home', url: `${siteConfig.siteUrl}/` },
        { name: 'California Locations', url: `${siteConfig.siteUrl}/california-locations` },
        { name: 'Duarte', url: `${siteConfig.siteUrl}/duarte-trade-attorney` }
      ]),
      generateServiceSchema({
        name: 'Duarte Trade Compliance Legal Services',
        description: 'Comprehensive trade compliance, customs defense, and import/export legal representation for Duarte businesses.',
  ...
  return (
    <div className="font-montserrat text-neutral-darkGray bg-white min-h-screen">
      ...
      {/* Hero Section */}
      <section className="hero" aria-label="Duarte Trade Attorney Hero">
        ...
        <div className="container">
          <h1>Duarte Trade Attorney<br />California Customs Compliance Lawyer</h1>
          <p className="hero-subtitle">
            Expert trade compliance counsel for Duarte businesses. Healthcare and biotech corridor, City of Hope. Tariff classification, customs defense, and import/export strategy.
          </p>
        ...
        <div className="max-w-[1200px] mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold font-garamond text-primary-navy mb-6">
              Trade Compliance for Duarte Businesses
            </h2>
            <div className="w-24 h-1 bg-secondary-teal mx-auto mb-6"></div>
            <p className="text-xl text-text-secondary max-w-3xl mx-auto leading-relaxed">
              Duarte businesses importing goods need more than logistics—they need <strong>legal compliance</strong>. Tariff misclassification, customs penalties, and regulatory violations can devastate your business. We protect Duarte importers and exporters.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-neutral-50 p-8 rounded-lg border-l-4 border-secondary-teal">
              ...
              <p className="text-text-secondary leading-relaxed">
                As your Duarte trade attorney, we serve <strong>importers, manufacturers, and distributors</strong> throughout the San Gabriel Valley. Industry focus: Healthcare, biotechnology, medical devices.
              </p>
            </div>
            ...
            <div className="bg-neutral-50 p-8 rounded-lg border-l-4 border-secondary-teal">
              ...
              <p className="text-text-secondary leading-relaxed">
                Facing a <strong>CBP audit or penalty notice</strong>? We defend Duarte businesses in customs enforcement actions, filing prior disclosures and negotiating settlements.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 px-6 bg-neutral-50">
        <div className="max-w-[1200px] mx-auto">
          <h2 className="text-4xl md:text-5xl font-bold font-garamond text-primary-navy mb-12 text-center">
            Trade Compliance Services for Duarte
          </h2>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white p-8 rounded-lg shadow-md hover:shadow-lg transition-shadow">
              ...
              <p className="text-text-secondary leading-relaxed mb-4">
                A <strong>CBP audit</strong> can uncover years of compliance violations. We represent Duarte importers in Focused Assessments, Quick Response Audits, and all CBP compliance proceedings.
              </p>
              <ul className="list-disc list-inside space-y-2 text-text-secondary">
            ...
            <div className="bg-white p-8 rounded-lg shadow-md hover:shadow-lg transition-shadow">
              ...
              <p className="text-text-secondary leading-relaxed mb-4">
                Duarte importers sourcing from <strong>China</strong> face Section 301 additional duties up to 25%. We analyze List coverage, explore reclassification strategies, and advise on supply chain restructuring.
              </p>
              <ul className="list-disc list-inside space-y-2 text-text-secondary">
      ...
      <section className="py-20 px-6 bg-white">
        <div className="max-w-[1200px] mx-auto">
          <h2 className="text-4xl md:text-5xl font-bold font-garamond text-primary-navy mb-12 text-center">
            Why Duarte Companies Choose Us
          </h2>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              ...
              <p className="text-text-secondary leading-relaxed mb-6">
                We understand the Duarte business environment and have <strong>nationwide experience</strong> defending importers at all major U.S. ports.
              </p>
            </div>
      ...
      <section className="py-20 px-6 bg-white">
        <div className="max-w-[1200px] mx-auto">
          <h2 className="text-4xl md:text-5xl font-bold font-garamond text-primary-navy mb-6 text-center">
            Deep Duarte & San Gabriel Valley Knowledge
          </h2>
          <p className="text-xl text-text-secondary text-center mb-12 max-w-3xl mx-auto">
            Our attorneys understand Duarte's business environment and Southern California's trade infrastructure.
          </p>
      ...
      <section className="py-20 px-6 bg-primary-navy text-white">
        <div className="max-w-[900px] mx-auto text-center">
          ...
          <p className="text-xl mb-8 opacity-95 leading-relaxed text-white">
            Don't let customs violations threaten your business. Contact our Duarte trade attorney team for expert guidance on import compliance and CBP defense.
          </p>
...
export default DuarteTradeAttorneyPage;
