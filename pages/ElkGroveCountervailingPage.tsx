...
const ElkGroveCountervailingPage: React.FC = () => {
  useMeta({
    ...
    description: 'Elk Grove countervailing duty attorney defending against foreign subsidy duties. Expert CVD scope rulings, Commerce defense, tech & manufacturing trade law. (310) 744-1328.',
    keywords: 'countervailing duty attorney elk grove, cvd lawyer elk grove, subsidy defense attorney, commerce department lawyer elk grove, elk grove customs lawyer, trade remedy attorney',
    ...
    schema: [
      ...
      generateWebPageSchema({
        ...
        description: 'Expert Elk Grove countervailing duty attorney providing CVD defense, scope rulings, and subsidy investigation representation for Central Valley technology and manufacturing industries.',
      ...
      generateFAQSchema([
        ...
        },
        {
          ...
          answer: 'CBP's Enforce and Protect Act (EAPA) investigates CVD evasion through transshipment or misrepresentation of country of origin. EAPA investigations are serious - we provide immediate response including comprehensive questionnaires, supply chain documentation, manufacturing evidence, and substantial transformation analysis. Our Elk Grove attorney has defended numerous EAPA investigations successfully.',
        },
        {
          question: 'Do you serve other Central Valley cities besides Elk Grove?',
          answer: 'Yes, from our Elk Grove location we serve the entire Central Valley including Sacramento, Folsom, Rancho Cordova, Davis, Roseville, and Stockton. We represent technology companies, manufacturers, agricultural businesses, and importers throughout the Central Valley with countervailing duty and customs legal services.',
        },
      ]),
    ],
  });
    ...
    <div className="font-montserrat text-neutral-darkGray bg-white min-h-screen">
      ...
      <section className="hero" aria-label="Elk Grove Countervailing Duty Attorney Hero">
        ...
        <div className="container">
          <h1>Elk Grove Countervailing Duty Attorney<br />CVD Defense & Subsidy Law</h1>
          <p className="hero-subtitle">
            Expert countervailing duty defense for Elk Grove and Central Valley. CVD scope rulings, Commerce Department representation, and subsidy investigation defense.
          </p>
        ...
        <div className="max-w-[1200px] mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-text-secondary max-w-3xl mx-auto leading-relaxed">
              Countervailing duties can add <strong>10% to 200%+ in additional tariffs</strong> to offset foreign government subsidies. These duties affect Elk Grove technology companies, manufacturers, and importers of steel, aluminum, solar products, and electronics. Our Elk Grove countervailing duty attorney helps you navigate CVD orders, scope rulings, and Commerce Department proceedings.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-neutral-50 p-8 rounded-lg border-l-4 border-secondary-teal">
              ...
              <p className="text-text-secondary leading-relaxed">
                Deep understanding of <strong>Elk Grove technology sector</strong> CVD issues including solar panels, electronics, and semiconductor imports.
              </p>
            </div>
          ...
          <div className="space-y-6">
            <div className="bg-white p-8 rounded-lg shadow-md hover:shadow-lg transition-shadow">
              ...
              <p className="text-text-secondary leading-relaxed mb-4">
                A successful CVD scope ruling excludes your product from countervailing duty orders, <strong>eliminating massive subsidy duty liability</strong>. Our Elk Grove attorney prepares:
              </p>
            ...
            <div className="bg-white p-8 rounded-lg shadow-md hover:shadow-lg transition-shadow">
              ...
              <p className="text-text-secondary leading-relaxed mb-4">
                Many Elk Grove companies don't realize their imports are subject to CVD. We provide <strong>comprehensive CVD risk assessments</strong>:
              </p>
              <ul className="list-disc list-inside space-y-2 text-text-secondary">
      ...
      <section className="py-20 px-6 bg-white">
        <div className="max-w-[1200px] mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-12">
            {[
              { title: 'Solar Technology', impact: 'U.S. CVD 15-250%', examples: 'Solar panels, photovoltaic cells, solar modules from China, Taiwan, Vietnam, Malaysia facing massive CVD for government subsidies' },
              { title: 'Steel & Aluminum', impact: 'U.S. CVD 10-200%+', examples: 'Steel pipe, rebar, aluminum extrusions, metal fabrication materials facing CVD from China, India, Mexico, Vietnam' },
              { title: 'Electronics & Components', impact: 'U.S. CVD 5-100%', examples: 'Circuit boards, semiconductors, electronic components subject to CVD alleging foreign manufacturing subsidies' },
              { title: 'Manufacturing Materials', impact: 'U.S. CVD 15-150%', examples: 'Chemicals, paper products, tires, industrial equipment facing CVD for alleged government grants and tax benefits' },
            ].map((industry) => (
          ...
          <div className="bg-primary-navy text-white p-8 rounded-lg text-center">
            ...
            <p className="text-neutral-200">
              ...
              Elk Grove technology and manufacturing companies face significant CVD exposure.
        ...
        <div className="max-w-[1200px] mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8 justify-center">
            ...
            <div>
              ...
              <p className="text-text-secondary leading-relaxed mb-6">
                Understanding of <strong>Elk Grove tech industry CVD challenges</strong> including solar products, electronics imports, and manufacturing materials.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-text-secondary leading-relaxed mb-6">
                <strong>Successful CVD scope exclusions</strong> saving Elk Grove importers millions through well-crafted ruling requests and technical analysis.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-text-secondary leading-relaxed mb-6">
                <strong>Same-day response</strong> for CVD emergencies including EAPA notices, Commerce inquiries, and CBP detentions.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 px-6 bg-primary-navy text-white" id="schedule-consultation">
        <div className="max-w-[900px] mx-auto text-center">
          ...
          <p className="text-xl mb-8 opacity-95 leading-relaxed text-white">
            CVD rates can exceed 200%, destroying your profit margins. Our Elk Grove countervailing duty attorney helps you avoid or minimize these duties through scope rulings, subsidy analysis, and Commerce Department defense. Free consultation.
          </p>
