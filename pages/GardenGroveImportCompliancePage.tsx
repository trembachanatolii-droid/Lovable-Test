        ...
        <div className="max-w-[1200px] mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12 justify-center">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md overflow-hidden">
              ...
              <div className="space-y-0">
                <div className="relative group">
                  <Link to="/anaheim-customs-attorney" className="block py-3 text-primary-navy hover:text-secondary-teal transition-colors">
                ...
                <div className="relative group">
                  <Link to="/irvine-trade-compliance" className="block py-3 text-primary-navy hover:text-secondary-teal transition-colors">
