...
const GilroyTradeAttorneyPage: React.FC = () => {
  useMeta({
    title: 'Gilroy Trade Attorney | Agriculture Export & Food Import Lawyer CA',
    description: 'Gilroy trade attorney for agriculture exporters and food importers. FDA compliance, USDA regulations, produce exports. Garlic capital of the world. (310) 744-1328.',
    canonical: 'gilroy-trade-attorney',
    ogType: 'website',
    ogImage: `${siteConfig.siteUrl}/og-image-gilroy.jpg`,
    schema: [
      generateWebPageSchema({
        title: 'Gilroy Trade Attorney - Agriculture & Food Trade Compliance Lawyer',
        description: 'Serving Gilroy with expert agriculture export, food import compliance, FDA regulations, and produce trade legal services.',
        url: `${siteConfig.siteUrl}/gilroy-trade-attorney`,
      }),
      generateBreadcrumbSchema([
        { name: 'Home', url: `${siteConfig.siteUrl}/` },
        { name: 'Local Offices', url: `${siteConfig.siteUrl}/local-offices` },
        { name: 'Gilroy', url: `${siteConfig.siteUrl}/gilroy-trade-attorney` }
      ]),
      generateServiceSchema({
        name: 'Gilroy Trade Compliance Legal Services',
        description: 'Comprehensive agriculture export and food import legal representation for Gilroy businesses. Expert Gilroy trade attorney services including FDA food import compliance, USDA export certification, produce export licensing, phytosanitary requirements, Section 301 fresh produce exemptions, and agricultural trade law for California growers and food processors.',
  ...
  return (
    <div className="font-montserrat text-neutral-darkGray bg-white min-h-screen">
      ...
      <section className="hero" aria-label="Gilroy Trade Law Hero">
        ...
        <div className="container">
          <h1>Gilroy Trade Attorney<br />Agriculture & Food Trade Law</h1>
          <p className="hero-subtitle">
            Expert trade compliance for Gilroy's agriculture industry. Produce exports, food imports, FDA regulations, USDA certification, and international agricultural trade law.
          </p>
      ...
      {/* Why Gilroy Businesses Need Us */}
      <section className="py-20 px-6 bg-white">
        <div className="max-w-[1200px] mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold font-garamond text-primary-navy mb-6">
              Trade Law for Gilroy's Agriculture Economy
            </h2>
            <div className="w-24 h-1 bg-secondary-teal mx-auto mb-6"></div>
            <p className="text-xl text-text-secondary max-w-3xl mx-auto leading-relaxed">
              As the <strong>"Garlic Capital of the World"</strong>, Gilroy is California's agricultural powerhouse, producing garlic, tomatoes, onions, peppers, and specialty crops exported globally. With <strong>$500+ million in annual agricultural production</strong>, Gilroy farmers, processors, and exporters face complex <strong>FDA food safety regulations, USDA export certification requirements, phytosanitary standards, and international trade barriers</strong>.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-neutral-50 p-8 rounded-lg border-l-4 border-secondary-teal">
              ...
              <p className="text-text-secondary leading-relaxed">
                As your Gilroy trade attorney, we specialize in <strong>fresh produce exports, processed food shipments, and agricultural commodity trade</strong>. We obtain USDA phytosanitary certificates, navigate foreign import requirements, and resolve trade barriers for California growers.
              </p>
            </div>
            ...
            <div className="bg-neutral-50 p-8 rounded-lg border-l-4 border-secondary-teal">
              ...
              <p className="text-text-secondary leading-relaxed">
                Gilroy food processors importing <strong>spices, ingredients, and specialty products</strong> must comply with FDA food safety regulations including FSMA, FSVP, and Prior Notice requirements. We design FDA compliance programs and defend against import detentions.
              </p>
            </div>
      ...
      <section className="py-20 px-6 bg-neutral-50">
        <div className="max-w-[1200px] mx-auto">
          <h2 className="text-4xl md:text-5xl font-bold font-garamond text-primary-navy mb-12 text-center">
            Trade Compliance for Gilroy Agriculture Industry
          </h2>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white p-8 rounded-lg shadow-md hover:shadow-lg transition-shadow">
              ...
              <p className="text-text-secondary leading-relaxed mb-4">
                Gilroy businesses exporting <strong>processed foods containing meat, poultry, or dairy</strong> require USDA Food Safety and Inspection Service (FSIS) export certificates. We coordinate with USDA FSIS, obtain export certificates for specific destination countries, and ensure compliance with <strong>Hazard Analysis and Critical Control Points (HACCP)</strong> requirements.
              </p>
              <ul className="list-disc list-inside space-y-2 text-text-secondary">
      ...
      {/* Why Gilroy Companies Choose Us */}
      <section className="py-20 px-6 bg-white">
        <div className="max-w-[1200px] mx-auto">
          <h2 className="text-4xl md:text-5xl font-bold font-garamond text-primary-navy mb-12 text-center">
            Why Gilroy Agriculture Businesses Trust Our Firm
          </h2>
      ...
      <section className="py-20 px-6 bg-neutral-50">
        <div className="max-w-[1200px] mx-auto">
          <h2 className="text-4xl md:text-5xl font-bold font-garamond text-primary-navy mb-12 text-center">
            Gilroy Agriculture Sectors We Serve
          </h2>
          ...
          <div className="grid md:grid-cols-4 gap-6">
            <div className="bg-white p-6 rounded-lg text-center shadow-sm hover:shadow-md transition-shadow">
              ...
              <p className="text-sm text-text-secondary">Fresh garlic exports, dehydrated garlic, garlic powder</p>
            </div>
      ...
      <section className="py-20 px-6 bg-white">
        <div className="max-w-[1200px] mx-auto">
          <h2 className="text-4xl md:text-5xl font-bold font-garamond text-primary-navy mb-6 text-center">
            Deep Gilroy Local Knowledge
          </h2>
          <p className="text-xl text-text-secondary text-center mb-12 max-w-3xl mx-auto">
            Our attorneys understand Gilroy's agriculture infrastructure, South County farming operations, and California export logistics. We serve clients by appointment throughout Santa Clara and San Benito Counties.
          </p>

          <div className="grid md:grid-cols-2 gap-8 mb-12 justify-center">
            {/* Agriculture Infrastructure */}
            <div className="bg-neutral-50 p-8 rounded-lg">
              <h3 className="text-2xl font-bold text-primary-navy mb-4 font-garamond">Gilroy Agriculture Infrastructure</h3>
              ...
              <ul className="space-y-3 text-text-secondary">
                <li className="flex items-start">
                  ...
                  <span>Primary north-south corridor connecting Gilroy to Bay Area ports and markets</span>
                </li>
                <li className="flex items-start">
                ...
                <li className="flex items-start">
                  ...
                  <span>Gilroy area refrigerated warehouses for export staging</span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-neutral-50 p-8 rounded-lg">
              <h3 className="text-2xl font-bold text-primary-navy mb-4 font-garamond">Gilroy Agriculture Districts</h3>
              <p className="text-text-secondary mb-4">Key farming and processing areas:</p>
              <ul className="space-y-3 text-text-secondary">
                <li className="flex items-start">
                  <span className="text-secondary-teal font-bold mr-2">Gilroy District</span>
                  <span>Core garlic production area — "Garlic Capital of the World"</span>
                </li>
                <li className="flex items-start">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-12 justify-center">
            ...
            <div className="bg-neutral-50 p-8 rounded-lg">
              ...
              <p className="text-text-secondary mb-4">Key agencies for Gilroy agriculture compliance:</p>
              <ul className="space-y-3 text-text-secondary">
                <li className="flex items-start">
            ...
            {/* Local Contact Info */}
            <div className="bg-neutral-50 p-8 rounded-lg">
              <h3 className="text-2xl font-bold text-primary-navy mb-4 font-garamond">Serving Gilroy & South County</h3>
      ...
      <section className="py-20 px-6 bg-primary-navy text-white">
        <div className="max-w-[900px] mx-auto text-center">
          ...
          <p className="text-xl mb-8 opacity-95 leading-relaxed text-white">
            Don't let trade barriers or regulatory issues block your agricultural exports. Contact our Gilroy trade attorney team for expert produce export and food import compliance.
          </p>
...
export default GilroyTradeAttorneyPage;
