          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12 justify-center">
              ...
              <div className="space-y-0">
                <div className="service-link-item">
                  <Link to="/los-angeles-tariff-lawyer" className="service-link">
                    ...
                    <p className="service-link__description">Downtown LA customs attorney</p>
                    <div className="triangle-slide">
                      <svg className="triangle-slide__icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                        <path d="M5 12h14M12 5l7 7-7 7"/>
                      </svg>
                ...
                <div className="service-link-item">
                  <Link to="/torrance-trade-attorney" className="service-link">
                    ...
                    <p className="service-link__description">South Bay trade lawyer</p>
                    <div className="triangle-slide">
                      <svg className="triangle-slide__icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                        <path d="M5 12h14M12 5l7 7-7 7"/>
                      </svg>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md overflow-hidden">
              ...
              <div className="space-y-0">
                ...
                <div className="service-link-item">
                  <Link to="/resources/isa-program-guide" className="service-link">
                    <span className="service-link__title">ISA Program Guide</span>
                    <div className="triangle-slide">
                      <svg className="triangle-slide__icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                        <path d="M5 12h14M12 5l7 7-7 7"/>
                      </svg>
