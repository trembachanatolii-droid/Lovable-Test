...
const LaHabraTradeAttorneyPage: React.FC = () => {
  useMeta({
    title: 'La Habra Trade Attorney | Import Export Compliance Lawyer CA',
    description: 'La Habra trade attorney for manufacturers. Customs compliance, USMCA, tariff classification. Orange/LA County border. (310) 744-1328.',
    canonical: 'la-habra-trade-attorney',
    ogType: 'website',
    ogImage: `${siteConfig.siteUrl}/og-image-la-habra.jpg`,
    schema: [
      generateWebPageSchema({
        title: 'La Habra Trade Compliance Attorney - Import Export Lawyer',
        description: 'Serving La Habra, CA with expert trade compliance, import/export law, and customs legal services for manufacturers and distributors in Orange/LA County Border.',
        url: `${siteConfig.siteUrl}/la-habra-trade-attorney`,
      }),
      generateBreadcrumbSchema([
        { name: 'Home', url: `${siteConfig.siteUrl}/` },
        { name: 'Local Offices', url: `${siteConfig.siteUrl}/local-offices` },
        { name: 'La Habra', url: `${siteConfig.siteUrl}/la-habra-trade-attorney` }
      ]),
      generateServiceSchema({
        name: 'La Habra Trade Compliance Legal Services',
        description: 'Comprehensive trade compliance, customs law, and import/export legal representation for La Habra manufacturers and distributors.',
  ...
  return (
    <div className="font-montserrat text-neutral-darkGray bg-white min-h-screen">
      ...
      {/* Hero Section */}
      <section className="hero" aria-label="La Habra Trade Law Hero">
        ...
        <div className="container">
          <h1>La Habra Trade Attorney<br />Import Export Compliance Lawyer</h1>
          <p className="hero-subtitle">
            Strategic trade compliance counsel for La Habra manufacturers and importers. Customs law, tariff optimization, and supply chain solutions at the Orange/LA County border.
          </p>
        ...
        <div className="max-w-[1200px] mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold font-garamond text-primary-navy mb-6">
              Trade Law for La Habra's Business Community
            </h2>
            <div className="w-24 h-1 bg-secondary-teal mx-auto mb-6"></div>
            <p className="text-xl text-text-secondary max-w-3xl mx-auto leading-relaxed">
              La Habra businesses face complex <strong>import/export regulations</strong> that require specialized legal expertise. Whether you're importing components, exporting finished goods, or navigating <strong>customs compliance</strong>, our trade attorneys provide expert guidance.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-neutral-50 p-8 rounded-lg border-l-4 border-secondary-teal">
              ...
              <p className="text-text-secondary leading-relaxed">
                As your <strong>La Habra trade attorney</strong>, we understand the local logistics corridors, port access routes, and regional supply chains in Orange/LA County Border. Strategic, practical counsel.
              </p>
            </div>
            ...
            <div className="bg-neutral-50 p-8 rounded-lg border-l-4 border-secondary-teal">
              ...
              <p className="text-text-secondary leading-relaxed">
                We serve La Habra's key industries with tariff classification, USMCA compliance, and Section 301 mitigation strategies tailored to your business needs.
              </p>
            </div>
      ...
      <section className="py-20 px-6 bg-neutral-50">
        <div className="max-w-[1200px] mx-auto">
          <h2 className="text-4xl md:text-5xl font-bold font-garamond text-primary-navy mb-12 text-center">
            Trade Compliance Services for La Habra Companies
          </h2>
      ...
      <section className="py-20 px-6 bg-white">
        <div className="max-w-[1200px] mx-auto">
          <h2 className="text-4xl md:text-5xl font-bold font-garamond text-primary-navy mb-12 text-center">
            Why La Habra Businesses Trust Us
          </h2>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              ...
              <p className="text-text-secondary leading-relaxed mb-6">
                We understand La Habra's logistics corridors and regional supply chains. Local knowledge means faster issue resolution.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-text-secondary leading-relaxed mb-6">
                We serve La Habra's key industries. We understand your products, margins, and regulatory pressures.
              </p>
            </div>
      ...
      <section className="py-20 px-6 bg-white">
        <div className="max-w-[1200px] mx-auto">
          <h2 className="text-4xl md:text-5xl font-bold font-garamond text-primary-navy mb-6 text-center">
            Deep La Habra Local Knowledge
          </h2>
          <p className="text-xl text-text-secondary text-center mb-12 max-w-3xl mx-auto">
            Our attorneys understand La Habra's position in Orange/LA County Border, with excellent access to LA/Long Beach ports. We serve clients by appointment throughout the La Habra area.
          </p>
      ...
      <section className="py-20 px-6 bg-primary-navy text-white">
        <div className="max-w-[900px] mx-auto text-center">
          ...
          <p className="text-xl mb-8 opacity-95 leading-relaxed text-white">
            Don't let customs compliance issues slow your business. Contact our La Habra trade attorney team for expert counsel.
          </p>
...
export default LaHabraTradeAttorneyPage;
