...
const MissionViejoDrawbackPage: React.FC = () => {
  useMeta({
    title: 'Duty Drawback Lawyer Mission Viejo | Tariff Refund Attorney CA',
    description: 'Mission Viejo duty drawback lawyer & tariff refund attorney. Recover 99% of paid import duties through manufacturing, unused, and rejected merchandise drawback. Orange County expertise. (310) 744-1328.',
    keywords: 'duty drawback lawyer mission viejo, tariff refund attorney mission viejo, drawback claims mission viejo, customs duty refund lawyer california, duty recovery attorney mission viejo, export drawback mission viejo',
    canonical: 'mission-viejo-duty-drawback',
    ogType: 'website',
    ogImage: `${siteConfig.siteUrl}/og-image-drawback.jpg`,
    schema: [
      generateLocalBusinessSchema(),
      generateWebPageSchema({
        title: 'Mission Viejo Duty Drawback Lawyer - Tariff Refund & Customs Duty Recovery Attorney',
        description: 'Expert Mission Viejo duty drawback lawyer helping California importers and exporters recover millions in paid customs duties through manufacturing, unused, and rejected merchandise drawback programs.',
        url: `${siteConfig.siteUrl}/#mission-viejo-duty-drawback`,
      }),
      generateBreadcrumbSchema([
        { name: 'Home', url: `${siteConfig.siteUrl}/` },
        { name: 'California Service Areas', url: `${siteConfig.siteUrl}/#california-offices` },
        { name: 'Mission Viejo Duty Drawback', url: `${siteConfig.siteUrl}/#mission-viejo-duty-drawback` }
      ]),
      generateFAQSchema([
        {
          question: 'What is duty drawback and how much can I recover?',
          answer: 'Duty drawback is a refund of up to 99% of customs duties, taxes, and certain fees paid on imported merchandise that is subsequently exported or destroyed. Under 19 USC § 1313, eligible companies can recover duties on manufacturing drawback (imported materials used in exported products), unused merchandise drawback (imported goods exported in same condition), and rejected merchandise drawback (defective imports). Our Mission Viejo duty drawback lawyers have recovered millions in tariff refunds for California exporters.',
        },
        {
          question: 'How long does it take to receive a duty drawback refund?',
          answer: 'CBP typically processes accelerated drawback claims (claims under $1 million filed with ACE) within 60-90 days. Non-accelerated claims can take 6-12 months. Complex manufacturing drawback claims requiring ruling requests may take longer. Our Mission Viejo duty drawback attorneys expedite the process through complete, accurate claim submissions and proactive follow-up with CBP.',
        },
        {
          question: 'Is duty drawback worth it for small exporters?',
          answer: 'Yes! Even if you export relatively small volumes, duty drawback can be highly profitable. If you paid $50,000 in duties and export those goods or similar goods, you can recover $49,500 (99%). The filing process can be streamlined through ACE, and our Mission Viejo duty drawback lawyer offers cost-effective flat-fee pricing that makes drawback accessible even for smaller exporters.',
        },
        {
        ...
        {
          question: 'Why choose a Mission Viejo duty drawback lawyer?',
          answer: 'Mission Viejo is centrally located in Orange County with direct access to major trade corridors, ports, and business centers. Our Mission Viejo location provides expertise with Orange County exporters, manufacturers, and distributors, along with established relationships with CBP drawback specialists serving Southern California.',
        },
      ]),
    ],
  });
  ...
  return (
    <div className="font-montserrat text-neutral-darkGray bg-white min-h-screen">
      ...
      {/* Hero Section */}
      <section className="hero" aria-label="Mission Viejo Duty Drawback Hero">
        ...
        <div className="container">
          <h1>Mission Viejo Duty Drawback Lawyer<br />Tariff Refund Attorney</h1>
          <p className="hero-subtitle">
            Recover 99% of paid customs duties through expert duty drawback claims. Orange County tariff refund specialists helping California exporters maximize duty recovery.
          </p>
      ...
      {/* Why Choose Mission Viejo Duty Drawback Services */}
      <section className="py-20 px-6 bg-white">
        <div className="max-w-[1200px] mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold font-garamond text-primary-navy mb-6">
              Maximize Your Duty Recovery in Orange County
            </h2>
            <div className="w-24 h-1 bg-secondary-teal mx-auto mb-6"></div>
            <p className="text-xl text-text-secondary max-w-3xl mx-auto leading-relaxed">
              Mission Viejo serves as a <strong>strategic business hub in Orange County</strong>, with access to major ports and thriving export businesses. If you're paying customs duties on imports and exporting goods, you could be leaving millions on the table. Our Mission Viejo duty drawback lawyers help you recover up to 99% of those duties.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-neutral-50 p-8 rounded-lg border-l-4 border-secondary-teal">
              ...
              <p className="text-text-secondary leading-relaxed">
                Serving <strong>Mission Viejo and Orange County businesses</strong> with comprehensive duty drawback services. Our regional expertise ensures efficient claim processing and maximum recovery.
              </p>
            </div>
        ...
        <div className="max-w-[1200px] mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12 justify-center">
            ...
            <div className="bg-neutral-50 p-6 rounded-lg shadow-md overflow-hidden">
              ...
              <div className="space-y-0">
                <div className="service-link-item">
                  <a href="#irvine-duty-drawback" className="service-link">
                    <span className="service-link__title">Irvine Drawback</span>
                    <p className="service-link__description">Orange County duty recovery</p>
                    <div className="triangle-slide">
                      <svg className="triangle-slide__icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                        <path d="M5 12h14M12 5l7 7-7 7"/>
                      </svg>
                ...
                <div className="service-link-item">
                  <a href="#long-beach-duty-drawback" className="service-link">
      ...
      {/* Related City Pages */}
      <RelatedCityPages currentCity="Mission Viejo" region="orange-county" />
      ...
      <section className="py-20 px-6 bg-primary-navy text-white">
        <div className="max-w-[900px] mx-auto text-center">
          ...
          <p className="text-xl mb-8 opacity-95 leading-relaxed text-white">
            Don't leave money on the table. Our Mission Viejo duty drawback lawyers will analyze your import/export activity and maximize your duty recovery. Free consultation and potential assessment.
          </p>
...
export default MissionViejoDrawbackPage;
