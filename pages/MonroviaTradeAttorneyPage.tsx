...
const MonroviaTradeAttorneyPage: React.FC = () => {
  useMeta({
    title: 'Monrovia Trade Attorney | San Gabriel Valley CA Customs Lawyer',
    description: 'Monrovia trade compliance attorney. Historic foothill community, light manufacturing. Import/export, tariff classification, CBP defense. (310) 744-1328.',
    canonical: 'monrovia-trade-attorney',
    ogType: 'website',
    ogImage: `${siteConfig.siteUrl}/og-image-monrovia.jpg`,
    schema: [
      generateWebPageSchema({
        title: 'Monrovia Trade Attorney - San Gabriel Valley Customs Compliance',
        description: 'Serving Monrovia with expert trade compliance, customs defense, and import/export legal services.',
        url: `${siteConfig.siteUrl}/monrovia-trade-attorney`,
      }),
      generateBreadcrumbSchema([
        { name: 'Home', url: `${siteConfig.siteUrl}/` },
        { name: 'California Locations', url: `${siteConfig.siteUrl}/california-locations` },
        { name: 'Monrovia', url: `${siteConfig.siteUrl}/monrovia-trade-attorney` }
      ]),
      generateServiceSchema({
        name: 'Monrovia Trade Compliance Legal Services',
        description: 'Comprehensive trade compliance, customs defense, and import/export legal representation for Monrovia businesses.',
  ...
  return (
    <div className="font-montserrat text-neutral-darkGray bg-white min-h-screen">
      ...
      {/* Hero Section */}
      <section className="hero" aria-label="Monrovia Trade Attorney Hero">
        ...
        <div className="container">
          <h1>Monrovia Trade Attorney<br />California Customs Compliance Lawyer</h1>
          <p className="hero-subtitle">
            Expert trade compliance counsel for Monrovia businesses. Historic foothill community, light manufacturing. Tariff classification, customs defense, and import/export strategy.
          </p>
        ...
        <div className="max-w-[1200px] mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold font-garamond text-primary-navy mb-6">
              Trade Compliance for Monrovia Businesses
            </h2>
            <div className="w-24 h-1 bg-secondary-teal mx-auto mb-6"></div>
            <p className="text-xl text-text-secondary max-w-3xl mx-auto leading-relaxed">
              Monrovia businesses importing goods need more than logistics—they need <strong>legal compliance</strong>. Tariff misclassification, customs penalties, and regulatory violations can devastate your business. We protect Monrovia importers and exporters.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-neutral-50 p-8 rounded-lg border-l-4 border-secondary-teal">
              ...
              <p className="text-text-secondary leading-relaxed">
                As your Monrovia trade attorney, we serve <strong>importers, manufacturers, and distributors</strong> throughout the San Gabriel Valley. Industry focus: Manufacturing, retail, small business.
              </p>
            </div>
            ...
            <div className="bg-neutral-50 p-8 rounded-lg border-l-4 border-secondary-teal">
              ...
              <p className="text-text-secondary leading-relaxed">
                Facing a <strong>CBP audit or penalty notice</strong>? We defend Monrovia businesses in customs enforcement actions, filing prior disclosures and negotiating settlements.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 px-6 bg-neutral-50">
        <div className="max-w-[1200px] mx-auto">
          <h2 className="text-4xl md:text-5xl font-bold font-garamond text-primary-navy mb-12 text-center">
            Trade Compliance Services for Monrovia
          </h2>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white p-8 rounded-lg shadow-md hover:shadow-lg transition-shadow">
              ...
              <p className="text-text-secondary leading-relaxed mb-4">
                A <strong>CBP audit</strong> can uncover years of compliance violations. We represent Monrovia importers in Focused Assessments, Quick Response Audits, and all CBP compliance proceedings.
              </p>
              <ul className="list-disc list-inside space-y-2 text-text-secondary">
            ...
            <div className="bg-white p-8 rounded-lg shadow-md hover:shadow-lg transition-shadow">
              ...
              <p className="text-text-secondary leading-relaxed mb-4">
                Monrovia importers sourcing from <strong>China</strong> face Section 301 additional duties up to 25%. We analyze List coverage, explore reclassification strategies, and advise on supply chain restructuring.
              </p>
              <ul className="list-disc list-inside space-y-2 text-text-secondary">
      ...
      <section className="py-20 px-6 bg-white">
        <div className="max-w-[1200px] mx-auto">
          <h2 className="text-4xl md:text-5xl font-bold font-garamond text-primary-navy mb-12 text-center">
            Why Monrovia Companies Choose Us
          </h2>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              ...
              <p className="text-text-secondary leading-relaxed mb-6">
                We understand the Monrovia business environment and have <strong>nationwide experience</strong> defending importers at all major U.S. ports.
              </p>
            </div>
      ...
      <section className="py-20 px-6 bg-white">
        <div className="max-w-[1200px] mx-auto">
          <h2 className="text-4xl md:text-5xl font-bold font-garamond text-primary-navy mb-6 text-center">
            Deep Monrovia & San Gabriel Valley Knowledge
          </h2>
          <p className="text-xl text-text-secondary text-center mb-12 max-w-3xl mx-auto">
            Our attorneys understand Monrovia's business environment and Southern California's trade infrastructure.
          </p>
      ...
      <section className="py-20 px-6 bg-primary-navy text-white">
        <div className="max-w-[900px] mx-auto text-center">
          ...
          <p className="text-xl mb-8 opacity-95 leading-relaxed text-white">
            Don't let customs violations threaten your business. Contact our Monrovia trade attorney team for expert guidance on import compliance and CBP defense.
          </p>
...
export default MonroviaTradeAttorneyPage;
