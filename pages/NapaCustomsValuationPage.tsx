...
const NapaCustomsValuationPage: React.FC = () => {
  useMeta({
    title: 'Napa Customs Valuation Attorney | Wine Country Trade Lawyer CA',
    description: 'Napa customs valuation attorney for Wine Country importers. Expert transaction value, assists, royalties, transfer pricing. Napa Valley customs lawyer. (310) 744-1328.',
    keywords: 'customs valuation attorney napa, transaction value lawyer wine country, transfer pricing attorney napa valley, customs valuation lawyer napa, royalties assists attorney california',
    canonical: 'napa-customs-valuation',
    ogType: 'website',
    ...
    <div className="font-montserrat text-neutral-darkGray bg-white min-h-screen">
      ...
      <section className="hero" aria-label="Napa Customs Valuation Hero">
        ...
        <div className="container">
          <h1>Napa Customs Valuation Attorney<br />Wine Country Transaction Value Lawyer</h1>
      ...
      {/* Why Choose Napa Customs Valuation Attorney */}
      <section className="py-20 px-6 bg-white">
        <div className="max-w-[1200px] mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold font-garamond text-primary-navy mb-6">
              Wine Country Customs Valuation Expertise
            </h2>
            <div className="w-24 h-1 bg-secondary-teal mx-auto mb-6"></div>
            <p className="text-xl text-text-secondary max-w-3xl mx-auto leading-relaxed">
              Napa Valley is the heart of <strong>California Wine Country and a global wine industry hub</strong>. Wineries, vineyards, and hospitality businesses importing wine equipment, barrels, bottles, corks, vineyard machinery, and luxury goods face complex customs valuation challenges. Our customs valuation attorney provides specialized services for transaction value, assists, royalties, transfer pricing, and related-party imports.
            </p>
          </div>

          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-neutral-50 p-8 rounded-lg border-l-4 border-secondary-teal">
              <h3 className="text-2xl font-bold text-primary-navy mb-4 font-garamond">Wine Industry Focus</h3>
              <p className="text-text-secondary leading-relaxed">
                Deep expertise in <strong>wine equipment, barrels, vineyard machinery, and hospitality goods valuation</strong>. We understand wine industry-specific issues.
              </p>
            </div>
          ...
          <div className="space-y-6">
            <div className="bg-white p-8 rounded-lg shadow-md hover:shadow-lg transition-shadow">
              ...
              <p className="text-text-secondary leading-relaxed mb-4">
                <strong>Transaction value</strong> is the price actually paid or payable for imported merchandise. It is the primary and preferred valuation method under 19 USC § 1401a. For Wine Country importers, establishing proper transaction value requires:
              </p>
              <ul className="list-disc list-inside space-y-2 text-text-secondary">
                ...
                <li>Valuation for wine equipment, barrels, and vineyard machinery</li>
            ...
            <div className="bg-white p-8 rounded-lg shadow-md hover:shadow-lg transition-shadow">
              ...
              <p className="text-text-secondary leading-relaxed mb-4">
                <strong>Assists</strong> are goods or services provided by the buyer to the seller, free or at reduced cost, for use in producing or selling imported merchandise. Common assists for Wine Country importers include:
              </p>
              <ul className="list-disc list-inside space-y-2 text-text-secondary">
                ...
                <li>Custom specifications for wine equipment and barrels</li>
            ...
            <div className="bg-white p-8 rounded-lg shadow-md hover:shadow-lg transition-shadow">
              ...
              <p className="text-text-secondary leading-relaxed mb-4">
                <strong>Royalties and license fees</strong> are dutiable if paid as a condition of sale and relate to imported merchandise. Napa companies with proprietary technology licensing face valuation challenges:
              </p>
              <ul className="list-disc list-inside space-y-2 text-text-secondary">
                ...
                <li>Brand licensing and trademark royalty analysis for luxury goods</li>
            ...
            <div className="bg-white p-8 rounded-lg shadow-md hover:shadow-lg transition-shadow">
              ...
              <p className="text-text-secondary leading-relaxed mb-4">
                Napa companies with foreign affiliates (especially European suppliers) face <strong>conflicting objectives between IRS transfer pricing and CBP customs valuation</strong>. Our services include:
              </p>
              <ul className="list-disc list-inside space-y-2 text-text-secondary">
            ...
            <div className="bg-white p-8 rounded-lg shadow-md hover:shadow-lg transition-shadow">
              ...
              <p className="text-text-secondary leading-relaxed mb-4">
                When importer and seller are <strong>related parties</strong> (common with European wine equipment manufacturers and foreign affiliates), CBP scrutinizes whether the relationship influenced price. Companies must prove:
              </p>
              <ul className="list-disc list-inside space-y-2 text-text-secondary">
      ...
      <section className="py-20 px-6 bg-white">
        <div className="max-w-[1200px] mx-auto">
          <h2 className="text-4xl md:text-5xl font-bold font-garamond text-primary-navy mb-12 text-center">
            Why Napa Importers Choose Trembach Law
          </h2>
          ...
          <div className="grid md:grid-cols-2 gap-8 justify-center">
            <div>
              ...
              <p className="text-text-secondary leading-relaxed mb-6">
                Deep understanding of <strong>Wine Country business operations</strong>. We know wine equipment, barrels, vineyard machinery, and hospitality goods valuation.
              </p>
            </div>
      ...
      <RelatedCityPages currentCity="Napa" region="northern-california" />
...
export default NapaCustomsValuationPage;
