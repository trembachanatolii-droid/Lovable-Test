...
const PaloAltoTradeAttorneyPage: React.FC = () => {
  useMeta({
    ...
    canonical: 'palo-alto-trade-attorney',
    ogType: 'website',
    ogImage: `${siteConfig.siteUrl}/og-image-palo-alto.jpg`,
    schema: [
      generateWebPageSchema({
        title: 'Palo Alto Trade Attorney - Silicon Valley Export Controls Lawyer',
        description: 'Serving Palo Alto tech companies with expert export controls, technology trade compliance, and encryption export legal services.',
        url: `${siteConfig.siteUrl}/palo-alto-trade-attorney`,
      }),
      generateBreadcrumbSchema([
        { name: 'Home', url: `${siteConfig.siteUrl}/` },
        { name: 'Local Offices', url: `${siteConfig.siteUrl}/local-offices` },
        { name: 'Palo Alto', url: `${siteConfig.siteUrl}/palo-alto-trade-attorney` }
      ]),
      generateServiceSchema({
        name: 'Palo Alto Trade Compliance Legal Services',
        description: 'Comprehensive trade compliance and export controls legal representation for Palo Alto technology companies. Expert Palo Alto trade attorney services including EAR/ITAR compliance, encryption export regulations, deemed export licensing, OFAC sanctions screening, semiconductor export controls, and hardware import/export compliance for Silicon Valley tech firms.',
    ...
    <div className="font-montserrat text-neutral-darkGray bg-white min-h-screen">
      ...
      <section className="hero" aria-label="Palo Alto Trade Law Hero">
        ...
        <div className="container">
          <h1>Palo Alto Trade Attorney<br />Silicon Valley Export Controls</h1>
          <p className="hero-subtitle">
            Expert export controls and technology trade compliance for Palo Alto's world-class tech companies. EAR/ITAR compliance, encryption regulations, and global expansion strategies.
          </p>
      ...
      {/* Why Palo Alto Tech Companies Need Us */}
      <section className="py-20 px-6 bg-white">
        <div className="max-w-[1200px] mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold font-garamond text-primary-navy mb-6">
              Trade Law for Palo Alto's Innovation Economy
            </h2>
            <div className="w-24 h-1 bg-secondary-teal mx-auto mb-6"></div>
            <p className="text-xl text-text-secondary max-w-3xl mx-auto leading-relaxed">
              Home to <strong>Stanford tech</strong> and numerous tech innovators, Palo Alto represents the pinnacle of Silicon Valley's global technology leadership. With products exported to <strong>150+ countries</strong>, Palo Alto tech companies face complex <strong>export control regulations, encryption export requirements, and international trade compliance challenges</strong>.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-neutral-50 p-8 rounded-lg border-l-4 border-secondary-teal">
              ...
              <p className="text-text-secondary leading-relaxed">
                As your Palo Alto trade attorney, we specialize in <strong>consumer electronics export compliance</strong>: smartphones, tablets, wearables, semiconductors, and IoT devices. We understand complex supply chains spanning Asia, Europe, and Americas.
              </p>
            </div>
            ...
            <div className="bg-neutral-50 p-8 rounded-lg border-l-4 border-secondary-teal">
              ...
              <p className="text-text-secondary leading-relaxed">
                Palo Alto companies manage <strong>global manufacturing and distribution networks</strong>. We advise on customs valuation (transfer pricing), country of origin marking, Section 301 tariffs, and regulatory compliance across multiple jurisdictions.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 px-6 bg-neutral-50">
        <div className="max-w-[1200px] mx-auto">
          <h2 className="text-4xl md:text-5xl font-bold font-garamond text-primary-navy mb-12 text-center">
            Trade Compliance for Palo Alto Technology Companies
          </h2>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white p-8 rounded-lg shadow-md hover:shadow-lg transition-shadow">
              ...
              <p className="text-text-secondary leading-relaxed mb-4">
                Palo Alto companies importing <strong>components and finished goods</strong> from Asia face complex customs requirements. We provide <strong>HTS classification, customs valuation (transfer pricing compliance), Section 301 tariff mitigation, and free trade agreement qualification</strong> (USMCA, US-Korea FTA, etc.).
              </p>
              <ul className="list-disc list-inside space-y-2 text-text-secondary">
      ...
      {/* Why Palo Alto Companies Choose Us */}
      <section className="py-20 px-6 bg-white">
        <div className="max-w-[1200px] mx-auto">
          <h2 className="text-4xl md:text-5xl font-bold font-garamond text-primary-navy mb-12 text-center">
            Why Palo Alto Tech Companies Trust Our Firm
          </h2>
      ...
      <section className="py-20 px-6 bg-neutral-50">
        <div className="max-w-[1200px] mx-auto">
          <h2 className="text-4xl md:text-5xl font-bold font-garamond text-primary-navy mb-12 text-center">
            Palo Alto Technology Sectors We Serve
          </h2>
      ...
      <section className="py-20 px-6 bg-white">
        <div className="max-w-[1200px] mx-auto">
          <h2 className="text-4xl md:text-5xl font-bold font-garamond text-primary-navy mb-6 text-center">
            Deep Palo Alto Local Knowledge
          </h2>
          <p className="text-xl text-text-secondary text-center mb-12 max-w-3xl mx-auto">
            Our attorneys understand Palo Alto's tech ecosystem, Silicon Valley business culture, and regional trade infrastructure. We serve clients by appointment throughout Santa Clara County.
          </p>

          <div className="grid md:grid-cols-2 gap-8 mb-12 justify-center">
            {/* Tech Corridors */}
            <div className="bg-neutral-50 p-8 rounded-lg">
              <h3 className="text-2xl font-bold text-primary-navy mb-4 font-garamond">Palo Alto Tech Corridors & Transportation</h3>
              ...
              <ul className="space-y-3 text-text-secondary">
                <li className="flex items-start">
                  ...
                  <span>Junipero Serra Freeway — connects Palo Alto to SF Peninsula and San Jose</span>
                </li>
                <li className="flex items-start">
                  <span className="text-secondary-teal font-bold mr-2">I-85</span>
                  <span>Connects Palo Alto to Mountain View, Sunnyvale, and San Jose</span>
                </li>
                <li className="flex items-start">
                ...
                <li className="flex items-start">
                  ...
                  <span>Major commercial corridor through Palo Alto</span>
                </li>
                <li className="flex items-start">
                  <span className="text-secondary-teal font-bold mr-2">San Jose Airport (SJC)</span>
                  <span>20 minutes from Palo Alto — air freight for semiconductor shipments</span>
                </li>
              </ul>
            </div>
            ...
            {/* Business Districts */}
            <div className="bg-neutral-50 p-8 rounded-lg">
              <h3 className="text-2xl font-bold text-primary-navy mb-4 font-garamond">Palo Alto Business & Tech Districts</h3>
              ...
              <ul className="space-y-3 text-text-secondary">
                ...
                <li className="flex items-start">
                  <span className="text-secondary-teal font-bold mr-2">Palo Alto Village</span>
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-12 justify-center">
            ...
            <div className="bg-neutral-50 p-8 rounded-lg">
              ...
              <p className="text-text-secondary mb-4">Logistics facilities serving Palo Alto tech companies:</p>
              <ul className="space-y-3 text-text-secondary">
                <li className="flex items-start">
                  <span className="text-secondary-teal font-bold mr-2">San Jose Airport (SJC)</span>
            ...
            {/* Local Contact Info */}
            <div className="bg-neutral-50 p-8 rounded-lg">
              <h3 className="text-2xl font-bold text-primary-navy mb-4 font-garamond">Serving Palo Alto & Silicon Valley</h3>
      ...
      <section className="py-20 px-6 bg-primary-navy text-white">
        <div className="max-w-[900px] mx-auto text-center">
          ...
          <p className="text-xl mb-8 opacity-95 leading-relaxed text-white">
            Don't let export compliance slow down your global product launches. Contact our Palo Alto trade attorney team for expert technology export controls and customs compliance.
          </p>
...
export default PaloAltoTradeAttorneyPage;
