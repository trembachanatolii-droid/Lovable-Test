...
const RialtoPriorDisclosurePage: React.FC = () => {
  useMeta({
    title: 'Prior Disclosure Attorney Rialto | CBP Penalty Defense',
    description: 'Rialto prior disclosure attorney. Expert CBP penalty mitigation & voluntary disclosure filings. Reduce customs penalties by 75%+. Inland Empire access. (310) 744-1328.',
    keywords: 'prior disclosure attorney rialto, cbp prior disclosure rialto, customs penalty attorney rialto, voluntary disclosure attorney rialto, customs penalty mitigation rialto, prior disclosure lawyer california',
    canonical: 'rialto-prior-disclosure-attorney',
    ogType: 'website',
    ogImage: `${siteConfig.siteUrl}/og-image-rialto-prior-disclosure.jpg`,
    schema: [
  ...
  return (
    <div className="font-montserrat text-neutral-darkGray bg-white min-h-screen">
      ...
      {/* Hero Section */}
      <section className="hero" aria-label="Rialto Prior Disclosure Attorney Hero">
        ...
        <div className="container">
          <h1>Rialto Prior Disclosure Attorney<br />CBP Penalty Mitigation Expert</h1>
        ...
        <div className="max-w-[1200px] mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-text-secondary max-w-3xl mx-auto leading-relaxed">
              When you discover import violations, filing a <strong>CBP prior disclosure</strong> is your most powerful tool to minimize penalties. Our Rialto prior disclosure attorneys have saved clients millions in potential penalties through timely, strategic voluntary disclosures.
            </p>
          </div>
      ...
      <section className="py-20 px-6 bg-neutral-50">
        <div className="max-w-[1200px] mx-auto">
          <h2 className="text-4xl md:text-5xl font-bold font-garamond text-primary-navy mb-12 text-center">
            Prior Disclosure Services in Rialto
          </h2>
          ...
          <div className="space-y-6">
            <div className="bg-white p-8 rounded-lg shadow-md hover:shadow-lg transition-shadow">
              ...
              <p className="text-text-secondary leading-relaxed mb-4">
                Our Rialto prior disclosure attorneys prepare comprehensive voluntary disclosures that meet all CBP requirements while minimizing your legal exposure. We handle <strong>duty calculations, legal analysis, and presentation</strong> to CBP Fines, Penalties & Forfeitures officers.
              </p>
            ...
            <div className="bg-white p-8 rounded-lg shadow-md hover:shadow-lg transition-shadow">
              ...
              <p className="text-text-secondary leading-relaxed mb-4">
                Our Rialto team conducts <strong>privileged internal audits</strong> to discover violations before CBP does. Attorney-client privilege protects audit findings, allowing you to correct issues strategically through prior disclosure.
              </p>
              <ul className="list-disc list-inside space-y-2 text-text-secondary">
            ...
            <div className="bg-white p-8 rounded-lg shadow-md hover:shadow-lg transition-shadow">
              ...
              <p className="text-text-secondary leading-relaxed mb-4">
                When CBP issues a CF-28 Request for Information or you receive audit notification, <strong>time is critical</strong>. Our Rialto office provides emergency prior disclosure services with 24-48 hour turnaround to preserve your penalty protection.
              </p>
              <ul className="list-disc list-inside space-y-2 text-text-secondary">
              ...
              <div className="space-y-0">
                <div className="service-link-item">
                  <a href="#riverside-tariff-attorney" className="service-link">
                    <span className="service-link__title">Riverside Customs</span>
                    <p className="service-link__description">Riverside County CBP</p>
                    <div className="triangle-slide">
                      <svg className="triangle-slide__icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                        <path d="M5 12h14M12 5l7 7-7 7"/>
                      </svg>
                ...
                <div className="service-link-item">
                  <a href="#ontario-trade-compliance" className="service-link">
                    <span className="service-link__title">Ontario Customs</span>
                    <p className="service-link__description">Ontario trade compliance</p>
                    <div className="triangle-slide">
                      <svg className="triangle-slide__icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                        <path d="M5 12h14M12 5l7 7-7 7"/>
                      </svg>
      ...
      {/* Related City Pages */}
      <RelatedCityPages currentCity="Rialto" region="inland-empire" />
...
export default RialtoPriorDisclosurePage;
