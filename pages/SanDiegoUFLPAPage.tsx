    ...
    <div className="font-montserrat text-neutral-darkGray bg-white min-h-screen">
      <section className="hero" aria-label="UFLPA Attorney San Diego Hero">
        <picture className="hero-bg">
          <img src="https://images.unsplash.com/photo-1605745341112-85968b19335b?q=80&w=1920&auto=format&fit=crop" alt="" role="presentation" width="1920" height="1080" loading="eager" decoding="async" className="hero-bg-image" />
        </picture>
