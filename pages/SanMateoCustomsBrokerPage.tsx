...
const SanMateoCustomsBrokerPage: React.FC = () => {
  useMeta({
    title: 'Customs Broker Liability Attorney San Mateo | Broker Defense Lawyer',
    description: 'San Mateo customs broker liability attorney. Expert broker negligence defense, CBP broker violations, broker license defense, professional liability. (310) 744-1328.',
    keywords: 'customs broker liability attorney san mateo, customs broker defense lawyer san mateo, broker negligence attorney, cbp broker violations lawyer, customs broker license defense california',
    canonical: 'san-mateo-customs-broker-liability-attorney',
    ogType: 'website',
    ogImage: `${siteConfig.siteUrl}/og-image-broker-san-mateo.jpg`,
    schema: [
      generateLocalBusinessSchema(),
      generateWebPageSchema({
        title: 'San Mateo Customs Broker Liability Attorney - Broker Defense & Professional Liability Lawyer',
        description: 'San Mateo customs broker liability attorney specializing in broker negligence defense, CBP broker violations, license defense, and professional liability.',
        url: `${siteConfig.siteUrl}/san-mateo-customs-broker-liability-attorney`,
      }),
      generateBreadcrumbSchema([
        { name: 'Home', url: `${siteConfig.siteUrl}/` },
        { name: 'California Service Areas', url: `${siteConfig.siteUrl}/california-offices` },
        { name: 'San Mateo Customs Broker Liability Attorney', url: `${siteConfig.siteUrl}/san-mateo-customs-broker-liability-attorney` }
      ]),
      generateFAQSchema([
        {
  ...
  return (
    <div className="font-montserrat text-neutral-darkGray bg-white min-h-screen">
      ...
      {/* Hero Section */}
      <section className="hero" aria-label="San Mateo Customs Broker Liability Attorney Hero">
        ...
        <div className="container">
          <h1>San Mateo Customs Broker Liability Attorney<br />Broker Defense Lawyer</h1>
          <p className="hero-subtitle">
            Expert customs broker liability attorney serving San Mateo and Peninsula brokers. Specialized broker negligence defense, CBP license violations, professional liability, and broker disciplinary proceedings.
          </p>
      ...
      <section className="py-20 px-6 bg-white">
        <div className="max-w-[1200px] mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-neutral-50 p-8 rounded-lg border-l-4 border-secondary-teal">
              <h3 className="text-2xl font-bold text-primary-navy mb-4 font-garamond">Bay Area Knowledge</h3>
              <p className="text-text-secondary leading-relaxed">
                Understanding of <strong>San Mateo CBP operations</strong> and local broker community challenges at SFO and Oakland ports.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 px-6 bg-neutral-50">
        <div className="max-w-[1200px] mx-auto">
          <h2 className="text-4xl md:text-5xl font-bold font-garamond text-primary-navy mb-12 text-center">
            Serving San Mateo & Peninsula Customs Brokers
          </h2>

          <div className="grid md:grid-cols-2 gap-8 mb-12">
            <div className="bg-white p-8 rounded-lg">
              <h3 className="text-2xl font-bold text-primary-navy mb-4 font-garamond">Peninsula Brokers</h3>
              <p className="text-text-secondary leading-relaxed mb-4">
                We serve <strong>customs brokers</strong> operating in San Mateo and the Peninsula:
              </p>
              <ul className="space-y-2 text-text-secondary">
                <li>• San Mateo customs brokers</li>
                <li>• Peninsula brokerage firms</li>
                <li>• Silicon Valley trade brokers</li>
            ...
            <div className="bg-white p-8 rounded-lg">
              ...
              <ul className="space-y-2 text-text-secondary">
                ...
                <li>• Air cargo brokers (SFO, SJC, OAK)</li>
      ...
      <section className="py-16 px-6 bg-neutral-50">
        <div className="max-w-[1200px] mx-auto">
          <h2 className="text-3xl font-bold font-garamond text-primary-navy mb-8 text-center">
            San Mateo Customs Broker Defense
          </h2>
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div className="text-center md:text-left">
              ...
              <address className="not-italic text-text-secondary leading-relaxed mb-4">
                ...
                (Serving San Mateo & Peninsula Customs Brokers)<br /><br />
      ...
      <RelatedCityPages currentCity="San Mateo" region="california" />
      ...
      <section className="py-20 px-6 bg-primary-navy text-white">
        <div className="max-w-[900px] mx-auto text-center">
          ...
          <p className="text-xl mb-8 opacity-95 leading-relaxed text-white">
            Contact our San Mateo customs broker liability attorneys today. We'll assess your situation, explain your options, and develop an aggressive defense strategy to protect your broker license.
          </p>
...
export default SanMateoCustomsBrokerPage;
