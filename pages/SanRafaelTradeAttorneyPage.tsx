...
const SanRafaelTradeAttorneyPage: React.FC = () => {
  useMeta({
    ...
    canonical: 'san-rafael-trade-attorney',
    ogType: 'website',
    ogImage: `${siteConfig.siteUrl}/og-image-san-rafael.jpg`,
    schema: [
      generateWebPageSchema({
        title: 'San Rafael Trade Attorney - California Port Customs Lawyer',
        description: 'Serving San Rafael with expert trade compliance, export controls, and customs legal services for biotech businesses and port-adjacent companies.',
        url: `${siteConfig.siteUrl}/san-rafael-trade-attorney`,
      }),
      generateBreadcrumbSchema([
        { name: 'Home', url: `${siteConfig.siteUrl}/` },
        { name: 'Local Offices', url: `${siteConfig.siteUrl}/local-offices` },
        { name: 'San Rafael', url: `${siteConfig.siteUrl}/san-rafael-trade-attorney` }
      ]),
      generateServiceSchema({
        name: 'San Rafael Trade Compliance Legal Services',
        description: 'Comprehensive trade compliance, export controls, and customs legal representation for San Rafael biotech businesses and port importers. Expert San Rafael trade attorney services including EAR/ITAR compliance, customs valuation, Port of Oakland logistics support, biotech trade compliance, and CBP examination defense.',
  ...
  return (
    <div className="font-montserrat text-neutral-darkGray bg-white min-h-screen">
      ...
      <section className="hero" aria-label="San Rafael Trade Law Hero">
        ...
        <div className="container">
          <h1>San Rafael Trade Attorney<br />Port Customs Compliance</h1>
          <p className="hero-subtitle">
            Expert customs and trade law services for San Rafael's biotech businesses. Oakland port access, import/export compliance, and CBP defense for Bay Area importers.
          </p>
      ...
      {/* Why San Rafael Businesses Need Us */}
      <section className="py-20 px-6 bg-white">
        <div className="max-w-[1200px] mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold font-garamond text-primary-navy mb-6">
              Trade Law for San Rafael's Maritime Economy
            </h2>
            <div className="w-24 h-1 bg-secondary-teal mx-auto mb-6"></div>
            <p className="text-xl text-text-secondary max-w-3xl mx-auto leading-relaxed">
              San Rafael's strategic location on San Francisco Bay provides direct access to the <strong>Port of Oakland</strong>, the nation's fifth-busiest container port. With proximity to biotech logistics operations and Bay Area distribution networks, San Rafael businesses face complex <strong>customs regulations, import compliance requirements, and trade law challenges</strong>.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-neutral-50 p-8 rounded-lg border-l-4 border-secondary-teal">
              ...
              <p className="text-text-secondary leading-relaxed">
                As your San Rafael trade attorney, we understand <strong>Port of Oakland logistics, Oakland International Container Terminal operations, and CBP examination procedures</strong>. We respond to customs holds, demurrage issues, and import violations within 24 hours.
              </p>
            </div>
            ...
            <div className="bg-neutral-50 p-8 rounded-lg border-l-4 border-secondary-teal">
              ...
              <p className="text-text-secondary leading-relaxed">
                We specialize in <strong>biotech customs compliance</strong>: containerized cargo, vessel documentation, ISF filings, and ocean freight regulations. We work with freight forwarders, customs brokers, and terminal operators serving San Rafael businesses.
              </p>
            </div>
      ...
      {/* Services for San Rafael Importers */}
      <section className="py-20 px-6 bg-neutral-50">
        <div className="max-w-[1200px] mx-auto">
          <h2 className="text-4xl md:text-5xl font-bold font-garamond text-primary-navy mb-12 text-center">
            Trade Compliance for San Rafael Port Businesses
          </h2>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white p-8 rounded-lg shadow-md hover:shadow-lg transition-shadow">
              <h3 className="text-2xl font-bold text-primary-navy mb-3 font-garamond">Port of Oakland Logistics Support</h3>
              <p className="text-text-secondary leading-relaxed mb-4">
                The Port of Oakland handles <strong>99% of containerized goods</strong> entering or leaving Northern California. We provide legal support for <strong>terminal operations, demurrage disputes, pier pass issues, and customs clearance problems</strong>. When cargo is held at SSA Marine, TraPac, or Everport terminals, we coordinate with CBP and terminal operators for rapid release.
              </p>
              <ul className="list-disc list-inside space-y-2 text-text-secondary">
            ...
            <div className="bg-white p-8 rounded-lg shadow-md hover:shadow-lg transition-shadow">
              ...
              <p className="text-text-secondary leading-relaxed mb-4">
                San Rafael businesses exporting goods internationally must comply with <strong>Export Administration Regulations (EAR) and ITAR</strong>. Even common biotech equipment may be subject to export licensing if it contains dual-use components. We classify your cargo, obtain export licenses, and ensure <strong>AES filing compliance</strong> before departure.
              </p>
              <ul className="list-disc list-inside space-y-2 text-text-secondary">
                <li>ECCN classification for biotech equipment and electronics</li>
      ...
      {/* Why San Rafael Companies Choose Us */}
      <section className="py-20 px-6 bg-white">
        <div className="max-w-[1200px] mx-auto">
          <h2 className="text-4xl md:text-5xl font-bold font-garamond text-primary-navy mb-12 text-center">
            Why San Rafael Businesses Trust Our Trade Law Firm
          </h2>
          ...
          <div className="grid md:grid-cols-2 gap-8 justify-center">
            <div>
              ...
              <p className="text-text-secondary leading-relaxed mb-6">
                We understand <strong>Port of Oakland terminal operations, drayage routes, and CBP examination procedures</strong>. We've handled customs issues at SSA Marine, TraPac, Matson, and Everport terminals. We know the freight corridors along I-880 and I-580 connecting San Rafael to distribution centers.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-text-secondary leading-relaxed mb-6">
                When CBP holds your cargo, <strong>every hour costs money</strong>. Demurrage at Port of Oakland terminals averages $150-$350/day. We respond to customs emergencies within 24 hours, coordinate with CBP officers, and expedite cargo release to minimize detention costs.
              </p>
            </div>
      ...
      <section className="py-20 px-6 bg-neutral-50">
        <div className="max-w-[1200px] mx-auto">
          <h2 className="text-4xl md:text-5xl font-bold font-garamond text-primary-navy mb-12 text-center">
            San Rafael Industries We Serve
          </h2>
      ...
      <section className="py-20 px-6 bg-white">
        <div className="max-w-[1200px] mx-auto">
          <h2 className="text-4xl md:text-5xl font-bold font-garamond text-primary-navy mb-6 text-center">
            Deep San Rafael Local Knowledge
          </h2>
          <p className="text-xl text-text-secondary text-center mb-12 max-w-3xl mx-auto">
            Our attorneys understand San Rafael's biotech infrastructure, Port of Oakland logistics, and Bay Area trade corridors. We serve clients by appointment throughout San Rafael County.
          </p>

          <div className="grid md:grid-cols-2 gap-8 mb-12 justify-center">
            {/* Port Access Routes */}
            <div className="bg-neutral-50 p-8 rounded-lg">
              <h3 className="text-2xl font-bold text-primary-navy mb-4 font-garamond">San Rafael Port Access & Freight Routes</h3>
              ...
              <ul className="space-y-3 text-text-secondary">
                <li className="flex items-start">
                  ...
                  <span>Nimitz Freeway — primary Port of Oakland access from San Rafael via Posey/Webster Tubes</span>
                </li>
                <li className="flex items-start">
                ...
                <li className="flex items-start">
                  ...
                  <span>Historical underwater tubes connecting San Rafael to Oakland port district</span>
                </li>
                <li className="flex items-start">
            ...
            <div className="bg-neutral-50 p-8 rounded-lg">
              <h3 className="text-2xl font-bold text-primary-navy mb-4 font-garamond">Port of Oakland CBP Operations</h3>
              <p className="text-text-secondary mb-4">Key customs facilities serving San Rafael importers:</p>
              <ul className="space-y-3 text-text-secondary">
                <li className="flex items-start">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-12 justify-center">
            ...
            <div className="bg-neutral-50 p-8 rounded-lg">
              <h3 className="text-2xl font-bold text-primary-navy mb-4 font-garamond">San Rafael Maritime Business Districts</h3>
              <p className="text-text-secondary mb-4">Key commercial areas for trade-related businesses:</p>
              <ul className="space-y-3 text-text-secondary">
                <li className="flex items-start">
                  <span className="text-secondary-teal font-bold mr-2">San Rafael Point</span>
                  <span>Former Naval Air Station — developing biotech industrial park, warehousing</span>
                </li>
                <li className="flex items-start">
                  <span className="text-secondary-teal font-bold mr-2">Bay Farm Island</span>
            ...
            {/* Local Contact Info */}
            <div className="bg-neutral-50 p-8 rounded-lg">
              <h3 className="text-2xl font-bold text-primary-navy mb-4 font-garamond">Serving San Rafael & Surrounding Areas</h3>
              <p className="text-text-secondary mb-4">Available by appointment throughout San Rafael County:</p>
              <div className="grid grid-cols-2 gap-2 text-sm text-text-secondary mb-4">
                <span>San Rafael</span>
                <span>Oakland</span>
                <span>Bay Farm Island</span>
                <span>San Rafael Point</span>
      ...
      <section className="py-20 px-6 bg-primary-navy text-white">
        <div className="max-w-[900px] mx-auto text-center">
          ...
          <p className="text-xl mb-8 opacity-95 leading-relaxed text-white">
            Don't let customs holds or CBP penalties disrupt your supply chain. Contact our San Rafael trade attorney team for expert port compliance and customs defense.
          </p>
...
export default SanRafaelTradeAttorneyPage;
