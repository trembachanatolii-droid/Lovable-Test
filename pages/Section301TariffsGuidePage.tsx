            ...
            <div className="space-y-6 mb-8">
              ...
              <div className="bg-white p-6 rounded-lg shadow-lg border-t-4 border-blue-600">
                ...
                <div className="bg-blue-50 p-4 rounded">
                  ...
                  <p className="text-sm text-red-700 font-semibold">⚠️ Important: List 4B was originally scheduled for Dec 15, 2019, but implementation was suspended. However, portions were later implemented. Verify specific HTS applicability carefully.</p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-6 mb-8">
              <div className="bg-white p-6 rounded-lg shadow-md border-l-4 border-secondary-teal">
                ...
                <div className="mt-3 bg-teal-50 p-3 rounded">
                  <p className="text-sm text-gray-800"><strong>⚠️ Classification Risk:</strong> Even minor classification differences can mean presence/absence of 25% additional duty. Small product modifications or reclassification can potentially avoid Section 301 coverage.</p>
                </div>
              </div>
                ...
                <div className="flex items-start mb-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-red-700 font-semibold mb-2">
                      ⚠️ Critical Compliance Warning: Ensure genuine substantial transformation occurs in new country. Simply routing Chinese goods through third country without meaningful processing is transshipment (illegal) and results in severe penalties.
                    </p>
                    <p className="text-sm text-gray-600 italic">
          ...
          <section id="compliance" className="mb-16">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-red-50 border-l-4 border-red-600 p-6">
                <h3 className="text-xl font-bold text-red-900 mb-3">⚠️ Common Section 301 Compliance Violations</h3>
