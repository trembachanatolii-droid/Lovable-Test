      ...
      <article className="max-w-4xl mx-auto pb-20 px-6 pt-16">
        ...
        <div className="space-y-8 leading-relaxed">
          ...
          <section id="acceptance" aria-labelledby="acceptance-heading">
            ...
            <p className="mb-4">
              Welcome to the website of Trembach Law Firm, APC ("Trembach Law," "we," "our," or "us"). These Terms of Use ("Terms") govern your access to and use of our website located at <a href="https://www.trembachlaw.com" target="_blank" rel="noopener noreferrer" className="text-secondary-teal hover:underline">www.trembachlaw.com</a> (the "Site"), including all content, functionality, and services offered on or through the Site.
            </p>
            <p className="mb-4">
