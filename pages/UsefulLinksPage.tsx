          ...
          <div className="bg-white rounded-lg shadow-md p-8 max-w-5xl mx-auto">
            <div className="relative">
              <input
                ...
                className="w-full py-4 pl-8 pr-16 text-base bg-white border border-gray-300 rounded focus:outline-none focus:border-gray-400 transition-all placeholder:text-gray-400 text-gray-700"
