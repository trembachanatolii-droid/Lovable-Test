...
const WestminsterTradeAttorneyPage: React.FC = () => {
  useMeta({
    title: 'Westminster Trade Attorney | Import Export Compliance Lawyer CA',
    description: 'Westminster trade attorney for importers & Asian food distributors. Customs compliance, FDA/CBP, tariff classification. OC. (310) 744-1328.',
    canonical: 'westminster-trade-attorney',
    ogType: 'website',
    ogImage: `${siteConfig.siteUrl}/og-image-westminster.jpg`,
    schema: [
      generateWebPageSchema({
        title: 'Westminster Trade Compliance Attorney - Import Export Lawyer',
        description: 'Serving Westminster, CA with expert trade compliance, import/export law, and customs legal services for manufacturers and distributors in Central Orange County.',
        url: `${siteConfig.siteUrl}/westminster-trade-attorney`,
      }),
      generateBreadcrumbSchema([
        { name: 'Home', url: `${siteConfig.siteUrl}/` },
        { name: 'Local Offices', url: `${siteConfig.siteUrl}/local-offices` },
        { name: 'Westminster', url: `${siteConfig.siteUrl}/westminster-trade-attorney` }
      ]),
      generateServiceSchema({
        name: 'Westminster Trade Compliance Legal Services',
        description: 'Comprehensive trade compliance, customs law, and import/export legal representation for Westminster manufacturers and distributors.',
  ...
  return (
    <div className="font-montserrat text-neutral-darkGray bg-white min-h-screen">
      ...
      {/* Hero Section */}
      <section className="hero" aria-label="Westminster Trade Law Hero">
        ...
        <div className="container">
          <h1>Westminster Trade Attorney<br />Import Export Compliance Lawyer</h1>
        ...
        <div className="max-w-[1200px] mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold font-garamond text-primary-navy mb-6">
              Trade Law for Westminster's Business Community
            </h2>
            <div className="w-24 h-1 bg-secondary-teal mx-auto mb-6"></div>
            <p className="text-xl text-text-secondary max-w-3xl mx-auto leading-relaxed">
              Westminster businesses face complex <strong>import/export regulations</strong> that require specialized legal expertise. Whether you're importing components, exporting finished goods, or navigating <strong>customs compliance</strong>, our trade attorneys provide expert guidance.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-neutral-50 p-8 rounded-lg border-l-4 border-secondary-teal">
              ...
              <p className="text-text-secondary leading-relaxed">
                As your <strong>Westminster trade attorney</strong>, we understand the local logistics corridors, port access routes, and regional supply chains in Central Orange County. Strategic, practical counsel.
              </p>
            </div>
            ...
            <div className="bg-neutral-50 p-8 rounded-lg border-l-4 border-secondary-teal">
              ...
              <p className="text-text-secondary leading-relaxed">
                We serve Westminster's key industries with tariff classification, USMCA compliance, and Section 301 mitigation strategies tailored to your business needs.
              </p>
            </div>
      ...
      <section className="py-20 px-6 bg-neutral-50">
        <div className="max-w-[1200px] mx-auto">
          <h2 className="text-4xl md:text-5xl font-bold font-garamond text-primary-navy mb-12 text-center">
            Trade Compliance Services for Westminster Companies
          </h2>
      ...
      <section className="py-20 px-6 bg-white">
        <div className="max-w-[1200px] mx-auto">
          <h2 className="text-4xl md:text-5xl font-bold font-garamond text-primary-navy mb-12 text-center">
            Why Westminster Businesses Trust Us
          </h2>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              ...
              <p className="text-text-secondary leading-relaxed mb-6">
                We understand Westminster's logistics corridors and regional supply chains. Local knowledge means faster issue resolution.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-text-secondary leading-relaxed mb-6">
                We serve Westminster's key industries. We understand your products, margins, and regulatory pressures.
              </p>
            </div>
      ...
      <section className="py-20 px-6 bg-neutral-50">
        <div className="max-w-[1200px] mx-auto">
          <h2 className="text-4xl md:text-5xl font-bold font-garamond text-primary-navy mb-12 text-center">
            Westminster Industries We Serve
          </h2>
      ...
      <section className="py-20 px-6 bg-white">
        <div className="max-w-[1200px] mx-auto">
          <h2 className="text-4xl md:text-5xl font-bold font-garamond text-primary-navy mb-6 text-center">
            Deep Westminster Local Knowledge
          </h2>
          <p className="text-xl text-text-secondary text-center mb-12 max-w-3xl mx-auto">
            Our attorneys understand Westminster's position in Central Orange County, with excellent access to LA/Long Beach ports. We serve clients by appointment throughout the Westminster area.
          </p>
...
export default WestminsterTradeAttorneyPage;
