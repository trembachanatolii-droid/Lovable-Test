...
// Batch 3 - Central Valley & Sacramento
...
// Batch 5 - Gateway Cities & Orange County
...
export const locationRoutes: RouteObject[] = [
  // Batch 1 - Major California Cities
  { path: '/anaheim-customs-attorney', element: <AnaheimCustomsAttorneyPage /> },
  { path: '/anaheim-manufacturing-trade', element: <AnaheimManufacturingTradePage /> },
  { path: '/antioch-customs-attorney', element: <AntiochCustomsAttorneyPage /> },
  { path: '/bakersfield-oil-energy-trade', element: <BakersfieldOilEnergyTradePage /> },
  { path: '/bakersfield-tariff-lawyer', element: <BakersfieldTariffLawyerPage /> },
  { path: '/chico-customs-attorney', element: <ChicoCustomsAttorneyPage /> },
  { path: '/chula-vista-tariff-lawyer', element: <ChulaVistaTariffLawyerPage /> },
  { path: '/concord-tariff-lawyer', element: <ConcordTariffLawyerPage /> },
  { path: '/corona-trade-compliance', element: <CoronaTradeCompliancePage /> },
  { path: '/daly-city-customs-attorney', element: <DalyCityCustomsAttorneyPage /> },
  { path: '/fontana-trade-attorney', element: <FontanaTradeAttorneyPage /> },
  { path: '/fremont-customs-attorney', element: <FremontCustomsAttorneyPage /> },
  { path: '/fresno-ag-export-compliance', element: <FresnoAgExportCompliancePage /> },
  { path: '/fresno-agricultural-trade', element: <FresnoAgriculturalTradePage /> },
  { path: '/fullerton-tariff-attorney', element: <FullertonTariffAttorneyPage /> },
  { path: '/glendale-tariff-attorney', element: <GlendaleTariffAttorneyPage /> },
  { path: '/hayward-customs-attorney', element: <HaywardCustomsAttorneyPage /> },
  { path: '/huntington-beach-tariff-lawyer', element: <HuntingtonBeachTariffLawyerPage /> },
  { path: '/irvine-trade-compliance', element: <IrvineTradeCompliancePage /> },
  { path: '/lancaster-trade-attorney', element: <LancasterTradeAttorneyPage /> },
  { path: '/modesto-customs-attorney', element: <ModestoCustomsAttorneyPage /> },
  { path: '/modesto-farm-equipment', element: <ModestoFarmEquipmentPage /> },
  { path: '/moreno-valley-customs', element: <MorenoValleyCustomsPage /> },
  { path: '/murrieta-tariff-lawyer', element: <MurrietaTariffLawyerPage /> },
  { path: '/oceanside-tariff-attorney', element: <OceansideTariffAttorneyPage /> },
  { path: '/ontario-trade-compliance', element: <OntarioTradeCompliancePage /> },
  { path: '/oxnard-tariff-attorney', element: <OxnardTariffAttorneyPage /> },
  { path: '/palmdale-customs-attorney', element: <PalmdaleCustomsAttorneyPage /> },
  { path: '/pasadena-tariff-lawyer', element: <PasadenaTariffLawyerPage /> },
  { path: '/rancho-cucamonga-tariff-lawyer', element: <RanchoCucamongaTariffLawyerPage /> },
  { path: '/riverside-tariff-attorney', element: <RiversideTariffAttorneyPage /> },
  { path: '/roseville-customs-lawyer', element: <RosevilleCustomsLawyerPage /> },
  { path: '/salinas-tariff-lawyer', element: <SalinasTariffLawyerPage /> },
  { path: '/santa-ana-trade-attorney', element: <SantaAnaTradeAttorneyPage /> },
  { path: '/santa-clarita-customs-lawyer', element: <SantaClaritaCustomsLawyerPage /> },
  { path: '/santa-rosa-customs-lawyer', element: <SantaRosaCustomsLawyerPage /> },
  { path: '/stockton-ag-tariff-lawyer', element: <StocktonAgTariffLawyerPage /> },
  { path: '/stockton-tariff-lawyer', element: <StocktonTariffLawyerPage /> },
  { path: '/sunnyvale-tech-trade', element: <SunnyvaleTechTradePage /> },
  { path: '/temecula-trade-attorney', element: <TemeculaTradeAttorneyPage /> },
  { path: '/torrance-trade-attorney', element: <TorranceTradeAttorneyPage /> },
  { path: '/vallejo-tariff-attorney', element: <VallejoTariffAttorneyPage /> },
  { path: '/visalia-tariff-lawyer', element: <VisaliaTariffLawyerPage /> },

  // Batch 2 - Bay Area Cities
  { path: '/novato-trade-attorney', element: <NovatoTradeAttorneyPage /> },
  { path: '/brentwood-trade-attorney', element: <BrentwoodTradeAttorneyPage /> },
  { path: '/pittsburg-trade-attorney', element: <PittsburgTradeAttorneyPage /> },
  { path: '/pacifica-trade-attorney', element: <PacificaTradeAttorneyPage /> },
  { path: '/south-san-francisco-trade-attorney', element: <SouthSanFranciscoTradeAttorneyPage /> },
  { path: '/san-bruno-trade-attorney', element: <SanBrunoTradeAttorneyPage /> },
  { path: '/burlingame-trade-attorney', element: <BurlingameTradeAttorneyPage /> },
  { path: '/san-carlos-trade-attorney', element: <SanCarlosTradeAttorneyPage /> },
  { path: '/foster-city-trade-attorney', element: <FosterCityTradeAttorneyPage /> },
  { path: '/menlo-park-trade-attorney', element: <MenloParkTradeAttorneyPage /> },
  { path: '/los-altos-trade-attorney', element: <LosAltosTradeAttorneyPage /> },
  { path: '/saratoga-trade-attorney', element: <SaratogaTradeAttorneyPage /> },
  { path: '/campbell-trade-attorney', element: <CampbellTradeAttorneyPage /> },
  { path: '/los-gatos-trade-attorney', element: <LosGatosTradeAttorneyPage /> },
  { path: '/morgan-hill-trade-attorney', element: <MorganHillTradeAttorneyPage /> },
  { path: '/hollister-trade-attorney', element: <HollisterTradeAttorneyPage /> },
  { path: '/madera-trade-attorney', element: <MaderaTradeAttorneyPage /> },

  // Batch 3 - Central Valley & Sacramento
  { path: '/merced-trade-attorney', element: <MercedTradeAttorneyPage /> },
  { path: '/turlock-trade-attorney', element: <TurlockTradeAttorneyPage /> },
  { path: '/los-banos-trade-attorney', element: <LosBanosTradeAttorneyPage /> },
  { path: '/ceres-trade-attorney', element: <CeresTradeAttorneyPage /> },
  { path: '/lodi-trade-attorney', element: <LodiTradeAttorneyPage /> },
  { path: '/galt-trade-attorney', element: <GaltTradeAttorneyPage /> },
  { path: '/folsom-trade-attorney', element: <FolsomTradeAttorneyPage /> },
  { path: '/citrus-heights-trade-attorney', element: <CitrusHeightsTradeAttorneyPage /> },
  { path: '/rancho-cordova-trade-attorney', element: <RanchoCordovaTradeAttorneyPage /> },
  { path: '/rocklin-trade-attorney', element: <RocklinTradeAttorneyPage /> },
  { path: '/lincoln-trade-attorney', element: <LincolnTradeAttorneyPage /> },
  { path: '/woodland-trade-attorney', element: <WoodlandTradeAttorneyPage /> },
  { path: '/davis-trade-attorney', element: <DavisTradeAttorneyPage /> },
  { path: '/suisun-city-trade-attorney', element: <SuisunCityTradeAttorneyPage /> },
  { path: '/benicia-trade-attorney', element: <BeniciaTradeAttorneyPage /> },
  { path: '/martinez-trade-attorney', element: <MartinezTradeAttorneyPage /> },
  { path: '/covina-trade-attorney', element: <CovinaTradeAttorneyPage /> },

  // Batch 4 - San Gabriel Valley
  { path: '/azusa-trade-attorney', element: <AzusaTradeAttorneyPage /> },
  { path: '/glendora-trade-attorney', element: <GlendoraTradeAttorneyPage /> },
  { path: '/la-verne-trade-attorney', element: <LaVerneTradeAttorneyPage /> },
  { path: '/claremont-trade-attorney', element: <ClaremontTradeAttorneyPage /> },
  { path: '/san-dimas-trade-attorney', element: <SanDimasTradeAttorneyPage /> },
  { path: '/arcadia-trade-attorney', element: <ArcadiaTradeAttorneyPage /> },
  { path: '/monrovia-trade-attorney', element: <MonroviaTradeAttorneyPage /> },
  { path: '/duarte-trade-attorney', element: <DuarteTradeAttorneyPage /> },
  { path: '/alhambra-trade-attorney', element: <AlhambraTradeAttorneyPage /> },
  { path: '/temple-city-trade-attorney', element: <TempleCityTradeAttorneyPage /> },
  { path: '/rosemead-trade-attorney', element: <RosemeadTradeAttorneyPage /> },
  { path: '/san-gabriel-trade-attorney', element: <SanGabrielTradeAttorneyPage /> },
  { path: '/montebello-trade-attorney', element: <MontebelloTradeAttorneyPage /> },
  { path: '/pico-rivera-trade-attorney', element: <PicoRiveraTradeAttorneyPage /> },
  { path: '/bell-gardens-trade-attorney', element: <BellGardensTradeAttorneyPage /> },
  { path: '/paramount-trade-attorney', element: <ParamountTradeAttorneyPage /> },
  { path: '/bellflower-trade-attorney', element: <BellflowerTradeAttorneyPage /> },

  // Batch 5 - Gateway Cities & Orange County
  { path: '/lakewood-trade-attorney', element: <LakewoodTradeAttorneyPage /> },
  { path: '/cerritos-trade-attorney', element: <CerritosTradeAttorneyPage /> },
  { path: '/artesia-trade-attorney', element: <ArtesiaTradeAttorneyPage /> },
  { path: '/la-mirada-trade-attorney', element: <LaMiradaTradeAttorneyPage /> },
  { path: '/norwalk-trade-attorney', element: <NorwalkTradeAttorneyPage /> },
  { path: '/santa-fe-springs-trade-attorney', element: <SantaFeSpringsTradeAttorneyPage /> },
  { path: '/la-habra-trade-attorney', element: <LaHabraTradeAttorneyPage /> },
  { path: '/brea-trade-attorney', element: <BreaTradeAttorneyPage /> },
  { path: '/yorba-linda-trade-attorney', element: <YorbaLindaTradeAttorneyPage /> },
  { path: '/placentia-trade-attorney', element: <PlacentiaTradeAttorneyPage /> },
  { path: '/buena-park-trade-attorney', element: <BuenaParkTradeAttorneyPage /> },
  { path: '/cypress-trade-attorney', element: <CypressTradeAttorneyPage /> },
  { path: '/la-palma-trade-attorney', element: <LaPalmaTradeAttorneyPage /> },
  { path: '/stanton-trade-attorney', element: <StantonTradeAttorneyPage /> },
  { path: '/westminster-trade-attorney', element: <WestminsterTradeAttorneyPage /> },
  { path: '/fountain-valley-trade-attorney', element: <FountainValleyTradeAttorneyPage /> },
  { path: '/seal-beach-trade-attorney', element: <SealBeachTradeAttorneyPage /> },

  // Batch 8 - Additional Cities
  { path: '/san-marcos-trade-attorney', element: <SanMarcosTradeAttorneyPage /> },
  { path: '/tustin-trade-attorney', element: <TustinTradeAttorneyPage /> },
  { path: '/whittier-trade-attorney', element: <WhittierTradeAttorneyPage /> },
  { path: '/newport-beach-trade-attorney', element: <NewportBeachTradeAttorneyPage /> },
  { path: '/alameda-trade-attorney', element: <AlamedaTradeAttorneyPage /> },
  { path: '/mountain-view-trade-attorney', element: <MountainViewTradeAttorneyPage /> },
  { path: '/palo-alto-trade-attorney', element: <PaloAltoTradeAttorneyPage /> },
  { path: '/cupertino-trade-attorney', element: <CupertinoTradeAttorneyPage /> },
  { path: '/milpitas-trade-attorney', element: <MilpitasTradeAttorneyPage /> },
  { path: '/union-city-trade-attorney', element: <UnionCityTradeAttorneyPage /> },
  { path: '/newark-trade-attorney', element: <NewarkTradeAttorneyPage /> },
  { path: '/dublin-trade-attorney', element: <DublinTradeAttorneyPage /> },
  { path: '/gilroy-trade-attorney', element: <GilroyTradeAttorneyPage /> },
  { path: '/monterey-trade-attorney', element: <MontereyTradeAttorneyPage /> },
